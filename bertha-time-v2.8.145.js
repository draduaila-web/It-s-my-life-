...
(() => {
  ...
  function goalAreaIcon(area){
    const icons={
      exercicios:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 10v4M6.5 8v8M9 9.5v5M15 9.5v5M17.5 8v8M20 10v4M9 12h6"/></svg>',
  ...
  function ensureStyles(){
    ...
    .bertha-ideal-hero{
      ...
      background:
        linear-gradient(135deg, rgba(246,214,224,.74) 0%, rgba(252,246,239,.96) 30%, rgba(230,242,255,.94) 100%),
        linear-gradient(135deg, rgba(255,255,255,0) 42%, rgba(255,245,205,.36) 46%, rgba(255,255,255,.98) 49.4%, rgba(255,250,234,1) 50%, rgba(255,255,255,.98) 50.6%, rgba(255,245,205,.34) 54%, rgba(255,255,255,0) 58%),
        radial-gradient(ellipse 13% 120% at 50% 48%, rgba(255,255,255,.99) 0%, rgba(255,252,232,.94) 18%, rgba(255,247,207,.52) 26%, rgba(255,247,207,0) 39%)!important;
    ...
    .bertha-ideal-page .primary.add-full{
      background:linear-gradient(135deg, rgba(226,171,191,.98) 0%, rgba(214,227,246,.98) 100%)!important;
      color:#fff!important;border:1px solid rgba(201,161,180,.24)!important;box-shadow:0 10px 24px rgba(196,170,198,.12)!important
    }
    ...
    .bertha-goal-card.goal-exercicios{background:linear-gradient(135deg,rgba(252,248,244,.98),rgba(242,231,248,.28) 38%,rgba(251,238,229,.22) 100%)}
    .bertha-goal-card.goal-exercicios .bertha-goal-icon{color:#8a6c98}
    ...
    .bertha-dialog .bertha-primary{
      background:linear-gradient(135deg, rgba(246,196,205,.96), rgba(252,229,197,.96) 48%, rgba(224,239,249,.98))!important;
      color:#fff!important;border:1px solid rgba(234,193,202,.22)!important;box-shadow:none!important
    }
