...
/* =========================================================
   CRIAÇÃO & IDEIAS — v2.8.102 · look azul + modal adaptativo
...
function renderFinanceiro(){
 ...
 app.innerHTML=`<section class="finance-hero"><div><span class="finance-hero-kicker">FINANCEIRO</span><h2>Know what’s ahead.<br>Make room for life.</h2><p>Você registra o essencial.<br>A BERTH.A clareia o horizonte.</p></div><span class="finance-hero-icon" aria-hidden="true">$</span></section>
...
.finance-hero-kicker{display:block;color:#6652a0;font-size:12px;font-weight:800;letter-spacing:.18em;margin-bottom:8px}.finance-hero h2{margin:0;color:#24233b;font-size:clamp(29px,8vw,39px);line-height:1.02;letter-spacing:-.035em;font-family:inherit;font-weight:700}.finance-hero p{margin:12px 0 0;color:#777184;font-size:16px;line-height:1.42}.finance-hero-icon{position:absolute;right:24px;top:24px;color:#6b78aa;font-size:28px;opacity:.8}
