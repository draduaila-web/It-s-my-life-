/* BERTH.A — Meu Dia v2 / Motor de Tempo v2.8.60 — Home com Compras, Progresso e Saúde
...
(() => {
  ...
  function repeatCandidatesToday(){const t=iso();return repeatQueue().filter(x=>x.status==='eligible'&&(!x.eligibleDate||x.eligibleDate<=t)&&x.kind!=='ideal'&&x.source!=='Meu Dia Ideal');}
  ...
  function sourcesToday(){
    ...
    // Defesa v2.8.62: Meu Dia Ideal é meta/referência, nunca item executável, inclusive filas legadas.
    return out.filter(x=>x.kind!=='ideal'&&x.source!=='Meu Dia Ideal');
  }
  ...
  function ensureStyles(){
    ...
    .topbar{align-items:center!important;position:relative!important;top:auto!important;z-index:1!important}
