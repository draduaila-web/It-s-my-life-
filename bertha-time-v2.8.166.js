...
(() => {
  ...
  function ensureMeuDiaV166Styles(){
    if(document.getElementById('bertha-meu-dia-v166'))return;
    const st=document.createElement('style');st.id='bertha-meu-dia-v166';st.textContent=`
      /* MEU DIA v166 — fluxo cromático contínuo da marca */
