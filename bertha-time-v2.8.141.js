...
(() => {
  ...
  function ensureStyles(){
    ...
    .bertha-ideal-hero{
      ...
      background:
        radial-gradient(circle at 49% 42%, rgba(255,248,213,.98) 0, rgba(255,250,232,.86) 10%, rgba(255,250,232,0) 20%),
        radial-gradient(circle at 50% 44%, rgba(255,255,255,.92) 0, rgba(255,255,255,0) 10%),
        linear-gradient(135deg, rgba(247,205,216,.88) 0%, rgba(252,244,233,.95) 34%, rgba(255,248,211,.92) 49%, rgba(239,248,255,.95) 66%, rgba(214,233,249,.88) 100%)!important;
    ...
    .bertha-ideal-hero:before{
      ...
      background:radial-gradient(circle, rgba(247,209,220,.38), rgba(247,209,220,0) 66%);pointer-events:none;
    }
    .bertha-ideal-hero:after{
      content:"";position:absolute;inset:-38px -36px auto auto;width:220px;height:220px;border-radius:50%;
      background:radial-gradient(circle, rgba(209,231,248,.32), rgba(209,231,248,0) 68%);pointer-events:none;
    }
    ...
    .bertha-ideal-page .primary.add-full{
      background:linear-gradient(135deg, rgba(246,188,203,.96), rgba(252,227,192,.96) 48%, rgba(220,239,250,.98))!important;
      color:#fff!important;border:1px solid rgba(232,191,201,.22)!important;box-shadow:0 10px 24px rgba(236,188,193,.12)!important
    }
    ...
    .bertha-ideal-zone.morning{background:linear-gradient(135deg,rgba(250,242,228,.96),rgba(247,229,235,.68) 44%,rgba(255,248,220,.82) 100%)}
    .bertha-ideal-zone.afternoon{background:linear-gradient(135deg,rgba(250,243,237,.96),rgba(248,233,240,.68) 40%,rgba(255,249,226,.80) 100%)}
    .bertha-ideal-zone.evening{background:linear-gradient(135deg,rgba(240,247,254,.96),rgba(228,240,250,.82) 54%,rgba(251,249,238,.82) 100%)}
    .bertha-ideal-zone.flex{background:linear-gradient(135deg,rgba(250,244,237,.96),rgba(238,247,253,.80) 60%,rgba(255,248,221,.78) 100%)}
    .bertha-ideal-zone.free{background:linear-gradient(135deg,rgba(248,244,237,.96),rgba(236,245,252,.78) 60%,rgba(255,248,223,.78) 100%)}
    ...
    .bertha-ideal-map-card{display:grid;grid-template-columns:minmax(0,1fr) 34px;align-items:center;gap:10px;padding:12px 10px 12px 14px;border-radius:16px;background:rgba(255,253,249,.70);border:1px solid rgba(86,73,89,.06)}
    ...
    .bertha-ideal-add-zone{width:100%;border:0;border-radius:13px;background:rgba(255,255,255,.58);padding:9px;margin-top:9px;color:#746f7e;font-size:10px;font-weight:750}
    .bertha-goals-head span{color:#8f8390}
    .bertha-goals-note{color:#7f7480}
    .bertha-goal-card{border:1px solid rgba(82,69,85,.08);background:linear-gradient(135deg,rgba(255,252,248,.92),rgba(240,247,253,.56));border-radius:17px;padding:13px;text-align:left;color:#4f4352;min-height:72px}
