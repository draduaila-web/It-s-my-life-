...
function ensureIdeasV297Styles(){
  ...
  #ideaDialog #ideaForm.bertha-modal{background:linear-gradient(145deg,rgba(255,253,250,.985),rgba(250,252,255,.985))!important;border:1px solid rgba(123,158,194,.18)!important;box-shadow:0 26px 70px rgba(44,55,78,.18)!important;color:var(--idea-ink)!important}
