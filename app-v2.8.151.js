...
function ensurePlansStyles(){if(document.getElementById('bertha-plans-v151'))return;const st=document.createElement('style');st.id='bertha-plans-v151';st.textContent=`
