...
function ensurePlansStyles(){if(document.getElementById('bertha-plans-v149'))return;const st=document.createElement('style');st.id='bertha-plans-v149';st.textContent=`
...
.plans-page{display:grid;gap:14px}.plans-hero{position:relative;overflow:hidden;padding:24px 22px 23px;border-radius:29px;border:1px solid rgba(182,143,105,.10);background:linear-gradient(135deg,rgba(255,248,221,.98),rgba(252,232,210,.72) 48%,rgba(255,244,224,.96));box-shadow:0 12px 34px rgba(91,69,47,.035)}.plans-hero:after{content:"";position:absolute;right:-30px;top:-44px;width:190px;height:190px;border-radius:50%;background:radial-gradient(circle,rgba(255,210,154,.24),rgba(255,210,154,0) 66%)}.plans-hero .eyebrow{font-size:11px;letter-spacing:.19em;font-weight:800;color:#99775f}.plans-hero h2{margin:7px 0 8px;font-size:29px;line-height:1.05;letter-spacing:-.035em;color:#3d3947;font-weight:500}.plans-hero p{margin:0;max-width:300px;color:#77706f;font-size:13.5px;line-height:1.45}.plans-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}.plans-entry{appearance:none;text-align:left;border:1px solid rgba(151,112,80,.08);border-radius:22px;padding:17px;background:linear-gradient(140deg,rgba(255,250,234,.98),rgba(252,229,207,.55));color:#403a40;min-height:128px;box-shadow:0 8px 22px rgba(95,68,42,.025)}.plans-entry.commit{background:linear-gradient(140deg,rgba(255,248,226,.98),rgba(249,218,194,.57))}.plans-entry svg{width:25px;height:25px;fill:none;stroke:#b78365;stroke-width:1.55;stroke-linecap:round;stroke-linejoin:round}.plans-entry strong{display:block;margin-top:18px;font-size:17px}.plans-entry span{display:block;margin-top:5px;font-size:11.5px;line-height:1.35;color:#847875}.plans-summary{display:grid;gap:10px}.plans-summary-card{border:1px solid rgba(105,88,75,.07);border-radius:20px;background:#fdf9f3;padding:15px}.plans-summary-card .k{font-size:10px;letter-spacing:.14em;font-weight:800;color:#9c8170}.plans-summary-card strong{display:block;margin-top:6px;color:#413b43;font-size:15px}.plans-summary-card small{display:block;margin-top:4px;color:#8d8280}.commit-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}.commit-add{border:0;border-radius:16px;padding:12px 15px;background:linear-gradient(135deg,#e6ad82,#f0caa2);color:white;font-weight:800}.commit-section{margin-top:18px}.commit-section h3{margin:0 0 9px;font-size:12px;letter-spacing:.12em;text-transform:uppercase;color:#887871}.commit-card{display:grid;grid-template-columns:64px minmax(0,1fr) 34px;gap:10px;align-items:center;padding:13px 11px;border:1px solid rgba(110,91,75,.07);border-radius:18px;background:#fdf9f3;margin-bottom:8px}.commit-time{font-size:13px;font-weight:800;color:#b47c5a}.commit-copy strong{display:block;font-size:14px;color:#413b43}.commit-copy small{display:block;margin-top:4px;color:#8a7f7b;font-size:11px}.commit-more{border:0;background:transparent;color:#9a8d89;font-size:22px}.commit-empty{padding:18px;border:1px dashed rgba(126,104,86,.14);border-radius:18px;color:#918580;font-size:12px;background:rgba(255,250,243,.5)}
.commit-dialog{border:0;padding:0;background:transparent;max-width:none}.commit-dialog::backdrop{background:rgba(53,48,52,.30);backdrop-filter:blur(4px)}.commit-modal{box-sizing:border-box;width:min(92vw,520px);max-height:min(88dvh,760px);overflow:auto;background:#fbf7f0;border:1px solid rgba(140,126,145,.10);border-radius:26px;padding:20px;box-shadow:0 20px 52px rgba(47,37,58,.14)}.commit-modal-head{display:flex;justify-content:space-between;align-items:flex-start;gap:14px;margin-bottom:15px}.commit-modal-head .eyebrow{font-size:10px;letter-spacing:.16em;font-weight:800;color:#9c7b64}.commit-modal-head h2{margin:5px 0 0;font-size:23px;color:#373440}.commit-x{border:0;background:transparent;color:#8e8792;font-size:25px;line-height:1;width:36px;height:36px}.commit-field{display:block;margin:12px 0}.commit-field>span{display:block;font-size:12px;font-weight:750;color:#655f67;margin-bottom:6px}.commit-field input,.commit-field select,.commit-field textarea{box-sizing:border-box;width:100%;min-height:46px;border:1px solid rgba(140,126,145,.14);border-radius:15px;background:#fffdfa;padding:11px 12px;color:#3e3d4b;font:inherit;font-size:16px}.commit-field textarea{min-height:86px;resize:vertical}.commit-two{display:grid;grid-template-columns:1fr 1fr;gap:9px}.commit-duration{display:grid;grid-template-columns:1fr 1.2fr;gap:9px}.commit-toggle-row{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:13px 0}.commit-toggle-row>div strong{display:block;font-size:13px;color:#4c4650}.commit-toggle-row>div small{display:block;margin-top:3px;font-size:11px;color:#8d848c}.commit-toggle{position:relative;width:48px;height:28px;flex:0 0 auto}.commit-toggle input{position:absolute;opacity:0}.commit-toggle i{display:block;width:48px;height:28px;border-radius:999px;background:#ded8d3;transition:.18s}.commit-toggle i:after{content:"";display:block;width:22px;height:22px;border-radius:50%;background:white;box-shadow:0 2px 6px rgba(0,0,0,.13);transform:translate(3px,3px);transition:.18s}.commit-toggle input:checked+i{background:#dfaa85}.commit-toggle input:checked+i:after{transform:translate(23px,3px)}.commit-expand{display:none}.commit-expand.on{display:block}.commit-actions{display:flex;justify-content:flex-end;gap:9px;margin-top:18px}.commit-actions button{border:0;border-radius:15px;padding:11px 16px;font-weight:800}.commit-actions .secondary{background:rgba(255,255,255,.72);color:#706972;border:1px solid rgba(140,126,145,.12)}.commit-actions .primary{background:linear-gradient(135deg,rgba(226,170,190,.98),rgba(245,224,200,.98) 44%,rgba(210,227,244,.99));color:white}.commit-delete{margin-right:auto!important;background:#fff1ee!important;color:#ad695e!important}.commit-reminder{display:grid;grid-template-columns:1fr 1.35fr;gap:9px}
