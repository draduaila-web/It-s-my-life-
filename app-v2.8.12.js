window.BERTHA_BUILD="2.8.12-casa";
...
function loadSharedShopping(){try{const x=JSON.parse(localStorage.getItem(SHARED_SHOP_KEY)||"[]");return Array.isArray(x)?x:[]}catch{return []}}
