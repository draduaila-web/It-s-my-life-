...
(() => {
  ...
  function ensureStyles(){
    ...
    .bertha-task-modal-head{
      ...
      background:
        radial-gradient(circle at 18% 8%,rgba(255,249,220,.70),transparent 52%),
        linear-gradient(135deg,rgba(255,251,232,.96),rgba(242,215,190,.68));
    }
    ...
    .bertha-segment button.active{
      background:linear-gradient(135deg,#f6e6b8,#e5b07a);color:#8a5f40;border-color:rgba(176,122,76,.18);
    ...
    .bertha-task-save{background:linear-gradient(135deg,#f6e6b8 0%,#e3ad76 52%,#c9825d 100%);color:white;min-width:92px}
