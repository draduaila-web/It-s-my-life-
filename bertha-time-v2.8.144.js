...
(() => {
  ...
  function goalAreaIcon(area){
    const icons={
      exercicios:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 10v4M6 8v8M9 9.5v5M15 9.5v5M18 8v8M21 10v4M9 12h6"/></svg>',
      alimentacao:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 20c5-3 7-7 7-11-4 0-8 2-11 7-2 3-2 6-2 6s3 0 6-2c5-3 7-7 7-11"/></svg>',
      autocuidado:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 20s-7-4.4-7-10a4 4 0 0 1 7-2.5A4 4 0 0 1 19 10c0 5.6-7 10-7 10z"/></svg>',
      estudos:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 6.5h6.5c1.5 0 2.5 1 2.5 2.5v8c0-1.5-1-2.5-2.5-2.5H4zM20 6.5h-6.5C12 6.5 11 7.5 11 9v8c0-1.5 1-2.5 2.5-2.5H20z"/></svg>',
      projetos:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 4v16M4 12h16M6.5 6.5l11 11M17.5 6.5l-11 11"/></svg>',
      trabalho:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 7V5.8c0-.9.7-1.6 1.6-1.6h4.8c.9 0 1.6.7 1.6 1.6V7M4 8.5h16v8.7c0 .9-.7 1.6-1.6 1.6H5.6c-.9 0-1.6-.7-1.6-1.6zM4 11.5h16"/></svg>',
      casa:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4.5 10.5 12 4l7.5 6.5V19a1 1 0 0 1-1 1H5.5a1 1 0 0 1-1-1zM9.5 20v-5h5v5"/></svg>',
      rituais:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3v3M12 18v3M4.9 4.9l2.1 2.1M17 17l2.1 2.1M3 12h3M18 12h3M4.9 19.1 7 17M17 7l2.1-2.1M12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7z"/></svg>'
    };
    return icons[area]||'';
  }
  ...
  function ensureStyles(){
    ...
    .bertha-ideal-hero{
      ...
      background:
        linear-gradient(135deg, rgba(248,221,228,.62) 0%, rgba(252,246,240,.95) 30%, rgba(233,244,255,.92) 100%),
        linear-gradient(135deg, rgba(255,255,255,0) 42%, rgba(255,246,210,.28) 46%, rgba(255,255,255,.95) 49.5%, rgba(255,252,240,1) 50%, rgba(255,255,255,.95) 50.5%, rgba(255,246,210,.26) 54%, rgba(255,255,255,0) 58%),
        radial-gradient(ellipse 12% 120% at 50% 48%, rgba(255,255,255,.98) 0%, rgba(255,251,230,.90) 16%, rgba(255,247,209,.42) 24%, rgba(255,247,209,0) 36%)!important;
    ...
    .bertha-ideal-hero h2{margin:0 0 10px!important;font-size:28px!important;line-height:1.04!important;letter-spacing:-.034em!important;font-weight:510!important;color:#2f344d!important;max-width:292px}
    .bertha-ideal-hero p{margin:0!important;max-width:282px;font-size:14px!important;line-height:1.42!important;color:#6b6e7f!important;font-weight:400!important}
    ...
    .bertha-ideal-page .primary.add-full{
      background:linear-gradient(135deg, rgba(245,202,211,.94) 0%, rgba(251,244,236,.96) 42%, rgba(233,244,251,.96) 100%)!important;
      color:#fff!important;border:1px solid rgba(232,191,201,.16)!important;box-shadow:0 10px 24px rgba(236,188,193,.08)!important
    }
    ...
    .bertha-goal-card{display:grid;grid-template-columns:28px minmax(0,1fr);align-items:center;gap:12px;padding:14px 14px;min-height:82px;border-color:rgba(82,69,85,.08);background:linear-gradient(135deg,rgba(253,250,245,.97),rgba(249,242,245,.12) 35%,rgba(238,246,252,.12) 70%,rgba(255,249,229,.10) 100%);box-shadow:0 6px 18px rgba(63,53,76,.025)}
    .bertha-goal-card span,.bertha-goal-card strong{display:block}
    .bertha-goal-icon{width:28px;height:28px;display:grid;place-items:center;color:#5d5570;opacity:.95}
    .bertha-goal-icon svg{width:24px;height:24px;fill:none;stroke:currentColor;stroke-width:1.75;stroke-linecap:round;stroke-linejoin:round}
    .bertha-goal-text{min-width:0;display:block}
    .bertha-goal-text > span{font-weight:760;color:#332d41;font-size:15px;line-height:1.18}
    .bertha-goal-text strong{font-size:12px;color:#807583;margin-top:6px;font-weight:700;line-height:1.3}
