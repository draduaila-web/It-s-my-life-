...
function ensurePlansStyles(){if(document.getElementById('bertha-plans-v150'))return;const st=document.createElement('style');st.id='bertha-plans-v150';st.textContent=`
