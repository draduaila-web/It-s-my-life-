...
function toggleFinPrivacyNative(){
 localStorage.setItem(FIN_PRIVACY_KEY,finPrivacyHidden()?"visible":"hidden");
 applyFinPrivacyNative();
}
function renderFinanceiro(){
 ...
 document.getElementById("toggleFinPrivacy").onclick=toggleFinPrivacyNative;
