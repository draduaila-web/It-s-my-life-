...
function renderCasaCore(){
 ...
 ${casaSection(casaLineIcon('basket'),"Lista de compras da Casa",`${loadCasaShopping().filter(x=>!x.done).length} pendentes`,`<div class="card casa-shopping-card"><p class="note">Produtos e utensílios enviados pelos procedimentos ficam aqui e também podem ser vistos na lista de compras.</p>${renderCasaShoppingMini()}</div>`,"casa-sec-compras")}`;
