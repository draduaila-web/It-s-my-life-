...
window.BERTHA_BUILD="2.8.131-casa-horarios-substitutos";
...
const casaV131=document.createElement('style');casaV131.id='casa-v131-horarios-substitutos';casaV131.textContent=`
.casa-schedule-row{grid-template-columns:110px minmax(0,1fr) auto!important;align-items:center!important;gap:10px!important}
.casa-time-stack{display:grid!important;gap:6px!important;justify-items:start!important;align-content:start!important}
.casa-time-stack .casa-time{display:inline-flex!important;align-items:center!important;justify-content:center!important;min-height:30px!important;padding:0 11px!important;line-height:1!important;white-space:nowrap!important}
.casa-schedule-row>strong{line-height:1.2!important}
...
@media(max-width:560px){.casa-schedule-row{grid-template-columns:96px minmax(0,1fr) auto!important}.casa-product-row{gap:12px!important}.casa-product-row>div:first-child{min-width:0!important}.casa-product-row>div:last-child{flex:0 0 auto!important}}
`;document.head.appendChild(casaV131);
