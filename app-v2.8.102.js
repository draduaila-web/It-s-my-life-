...
.goal-card{background:radial-gradient(circle at 90% 8%,rgba(122,203,193,.08),transparent 30%),linear-gradient(145deg,#fff,#fbf8ff)}.goal-toggle{background:#eee6f9!important;color:#74549a!important;border:0!important}.goal-toggle.done{background:#e8f2ef!important;color:#55796e!important}.excluded-card .pill{background:#f1e9f7;color:#71558f}.fin-due-alert{background:linear-gradient(120deg,#f7efff,#f3f5ff 74%,#f0f8f6)!important}.section-title{letter-spacing:.17em;color:#7d7582}.text-btn{color:#735696!important}
