/* BERTH.A v2.8.35 — Financeiro pessoal: acesso estável + contas previstas.
...
(() => {
  ...
  // Acesso robusto: chama o renderer financeiro diretamente.
  function openFinance(link){
    ...
    doRender();
    // Safari/iOS + camada BERTH.A podem rerenderizar logo após fechar o menu.
    [40,120,260].forEach(ms => setTimeout(doRender,ms));
  }
  ...
  window.addEventListener('hashchange', () => { if (currentRouteFinance()) setTimeout(()=>openFinance(null),20); });
