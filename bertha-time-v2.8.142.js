...
(() => {
  ...
  function ensureStyles(){
    ...
    .bertha-ideal-hero{
      ...
      background:
        linear-gradient(135deg, rgba(248,220,227,.72) 0%, rgba(252,245,238,.92) 28%, rgba(252,246,234,.94) 42%, rgba(234,245,255,.92) 77%, rgba(210,232,249,.82) 100%),
        linear-gradient(135deg, rgba(255,255,255,0) 35%, rgba(255,244,189,.54) 44%, rgba(255,255,255,.92) 50%, rgba(255,243,184,.50) 56%, rgba(255,255,255,0) 65%),
        radial-gradient(ellipse 18% 120% at 50% 48%, rgba(255,255,255,.98) 0%, rgba(255,250,221,.95) 18%, rgba(255,247,205,.74) 28%, rgba(255,247,205,0) 44%)!important;
    ...
    .bertha-ideal-hero h2{margin:0 0 10px!important;font-size:29px!important;line-height:1.02!important;letter-spacing:-.036em!important;font-weight:560!important;color:#2f344d!important;max-width:290px}
    .bertha-ideal-hero p{margin:0!important;max-width:280px;font-size:14px!important;line-height:1.4!important;color:#66697b!important}
    .bertha-ideal-hero-copy,.bertha-ideal-hero-mark{position:relative;z-index:1}
    .bertha-ideal-hero-mark{display:grid;place-items:start end;color:#c4c1c7;opacity:.92;padding-top:3px}
    .bertha-ideal-hero-mark svg{width:44px;height:44px;fill:none;stroke:currentColor;stroke-width:1.35;stroke-linecap:round;stroke-linejoin:round}
    .bertha-ideal-add-main,
    [data-route="ideal"] .primary.add-full,
    .bertha-ideal-page .primary.add-full{
      background:linear-gradient(135deg, rgba(245,198,208,.96) 0%, rgba(250,239,226,.96) 38%, rgba(255,243,188,.96) 50%, rgba(255,252,245,.94) 54%, rgba(228,241,250,.98) 100%)!important;
      color:#fff!important;border:1px solid rgba(232,191,201,.18)!important;box-shadow:0 10px 24px rgba(236,188,193,.10)!important
    }
    ...
    .bertha-goal-card{border:1px solid rgba(82,69,85,.07);background:linear-gradient(135deg,rgba(252,249,244,.96),rgba(248,240,243,.18) 35%,rgba(236,245,252,.16) 70%,rgba(255,249,226,.12) 100%);border-radius:17px;padding:13px;text-align:left;color:#4f4352;min-height:72px}
    ...
    @media(max-width:480px){
      ...
      .bertha-ideal-hero h2{font-size:27px!important;max-width:none}
