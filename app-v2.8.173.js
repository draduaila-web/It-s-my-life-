...
function ensureProgressStyles(){if(document.getElementById('bertha-progress-styles-v173'))return;const st=document.createElement('style');st.id='bertha-progress-styles-v173';st.textContent=`
/* v2.8.173 — Meu Progresso · editorial, auditável, sem dashboard genérico */
.progress-page{padding-bottom:24px}
.progress-hero{margin-bottom:18px!important;min-height:172px;padding:24px 23px!important;background:radial-gradient(circle at 13% 4%,rgba(255,255,255,.48),transparent 42%),linear-gradient(132deg,rgba(250,222,215,.91) 0%,rgba(245,216,229,.90) 34%,rgba(226,218,246,.88) 67%,rgba(211,232,246,.86) 100%)!important}
.progress-hero:after{display:none!important}
.progress-hero .eyebrow{color:#a47483!important}
.progress-hero h2{max-width:315px;font-size:27px!important;line-height:1.06!important;font-weight:520!important;letter-spacing:-.035em!important;margin:7px 0 9px!important}
.progress-hero p{font-size:14px!important;color:#7c717c!important}
.progress-hero-mark{position:absolute;right:20px;top:18px;width:62px;height:62px;color:rgba(91,87,96,.42);z-index:1}
.progress-hero-mark svg{width:100%;height:100%;fill:none;stroke:currentColor;stroke-width:1.15;stroke-linecap:round;stroke-linejoin:round}
...
.progress-section-head h3{margin:0;font-size:19px;line-height:1.15;color:#433b46}
...
.progress-category.progress-area-card,.progress-practical-list>.progress-category{margin:0!important;padding:0!important;border-radius:20px!important;background:#fff9f1!important;border:1px solid rgba(112,91,115,.075)!important;box-shadow:0 6px 18px rgba(72,57,76,.026)!important;overflow:hidden}
.progress-area-card .progress-category-head,.progress-practical-list .progress-category-head{list-style:none;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:15px 16px!important;cursor:pointer}
...
.progress-area-name{font-size:15.5px;font-weight:760;color:#443d47}
...
.progress-area-result b{font-size:14px;line-height:1.22;color:#725d76;font-weight:760}
