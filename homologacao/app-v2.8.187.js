...
window.BERTHA_BUILD="2.8.187-financeiro-hotfix-hml";
...
/* v2.8.187 deployment bridge: guarantees the visible finance controls use the current handlers. */
document.addEventListener('click',function(e){
  const privacy=e.target.closest&&e.target.closest('#toggleFinPrivacy');
  if(privacy){ e.preventDefault(); e.stopImmediatePropagation(); if(window.toggleFinPrivacyNative) window.toggleFinPrivacyNative(); return; }
