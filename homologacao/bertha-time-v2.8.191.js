...
(() => {
  ...
  function rerender(){
    ...
    if(route==='financeiro'){ const fn=(typeof window.renderFinanceiro==='function'?window.renderFinanceiro:window.__berthaCoreRenderFinanceiro); if(typeof fn==='function'){ fn(); nav(); return; } }
