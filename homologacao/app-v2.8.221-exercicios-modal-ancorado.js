...
function ensureFoodOwnerConfigStyles(){if(document.getElementById('bertha-food-owner-config-rc96'))return;const st=document.createElement('style');st.id='bertha-food-owner-config-rc96';st.textContent=`
...
function renderAlimentacao(){
 ensureFoodModuleStyles();ensureRC94FoodRecipeArchitectureStyles();ensureFoodPolishStylesRC87();ensureFoodArchitectureRC88();ensureFoodOwnerConfigStyles();
