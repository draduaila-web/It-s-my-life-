...
function ensureFoodOwnerConfigStyles(){if(document.getElementById('bertha-food-owner-config-rc97'))return;const st=document.createElement('style');st.id='bertha-food-owner-config-rc97';st.textContent=`
