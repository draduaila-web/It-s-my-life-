...
function ensureProgressStyles(){if(document.getElementById('bertha-progress-styles-v174'))return;const st=document.createElement('style');st.id='bertha-progress-styles-v174';st.textContent=`
/* v2.8.174 — Meu Progresso · hero editorial leve + cards auditáveis */
.progress-page{padding-bottom:24px}
.progress-hero{margin-bottom:20px!important;min-height:166px;padding:22px 22px 21px!important;background:radial-gradient(circle at 14% 6%,rgba(255,255,255,.52),transparent 44%),linear-gradient(132deg,rgba(250,224,216,.88) 0%,rgba(246,221,231,.86) 35%,rgba(229,222,246,.84) 68%,rgba(216,234,246,.82) 100%)!important}
.progress-hero:after{display:none!important}
.progress-hero .eyebrow{color:#a47483!important}
.progress-hero h2{max-width:300px;font-size:25px!important;line-height:1.08!important;font-weight:500!important;letter-spacing:-.032em!important;margin:6px 0 8px!important}
.progress-hero p{font-size:13.5px!important;color:#8b818b!important;line-height:1.4!important}
.progress-hero-mark{position:absolute;right:22px;top:21px;width:46px;height:46px;color:rgba(86,83,91,.38);z-index:1;display:grid;place-items:center}
.progress-hero-mark svg{width:36px;height:36px;fill:none;stroke:currentColor;stroke-width:1.15;stroke-linecap:round;stroke-linejoin:round}
.progress-section-head{display:flex;align-items:flex-end;justify-content:space-between;gap:12px;margin:0 2px 10px}
.progress-section-head>div>span{display:block;font-size:10.5px;letter-spacing:.18em;font-weight:800;color:#a27382;margin-bottom:4px}
.progress-section-head h3{margin:0;font-size:18px;line-height:1.15;color:#4b444d;font-weight:680}
.progress-section-head>small{font-size:11.5px;color:#948994;padding-bottom:2px}
.progress-week{margin-bottom:22px}
...
.progress-empty{padding:22px 18px;border-radius:20px;background:#fff9f1;border:1px solid rgba(112,91,115,.07);text-align:center}
.progress-empty strong,.progress-empty span{display:block}.progress-empty strong{color:#4a414c;font-size:14px}.progress-empty span{color:#8d828d;font-size:12px;margin-top:5px;line-height:1.4}
.progress-practical{margin-top:4px}
...
.progress-shopping-summary>div{padding:14px 15px;border-radius:20px;background:#fff9f1;border:1px solid rgba(112,91,115,.075);box-shadow:0 6px 18px rgba(72,57,76,.022)}
...
.progress-purchases{margin-top:9px;border-radius:20px;background:#fff9f1;border:1px solid rgba(112,91,115,.075);overflow:hidden}
...
@media(max-width:480px){.progress-hero{min-height:166px}.progress-hero h2{font-size:25px!important}.progress-area-result{max-width:46%}.progress-shopping-summary{grid-template-columns:1fr 1fr}}
`;document.head.appendChild(st)}
