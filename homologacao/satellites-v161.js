...
(function(){
  ...
  function styles(){
    ...
    const s=document.createElement('style');s.id=STYLE_ID;s.textContent=`
      ...
      .s156-hero{position:relative;overflow:hidden;padding:22px;border-radius:28px;background:linear-gradient(135deg,rgba(249,205,218,.68) 0%,rgba(255,245,224,.78) 42%,rgba(218,234,252,.86) 100%);border:1px solid rgba(170,157,177,.13);box-shadow:0 12px 28px rgba(74,57,69,.04)}
      ...
      .s156-network{position:absolute;right:24px;top:28px;width:52px;height:52px;opacity:.56}.s156-network svg{width:100%;height:100%;stroke:#989fb0;fill:none;stroke-width:1.35;stroke-linecap:round;stroke-linejoin:round}
      .s156-actions{display:flex;gap:9px;flex-wrap:wrap}.s156-main{flex:1;min-width:180px;min-height:50px;border:0;border-radius:22px;background:linear-gradient(90deg,rgba(232,150,182,.92) 0%,rgba(244,190,182,.86) 30%,rgba(247,221,183,.84) 52%,rgba(210,222,238,.90) 78%,rgba(178,211,226,.92) 100%);color:#fff;font-size:13px;font-weight:650}
  ...
  function renderSatellitesV157(){
    ...
    const network=`<svg viewBox="0 0 64 64" aria-hidden="true">
      <circle cx="32" cy="20" r="7"/>
      <circle cx="16" cy="26" r="5.5"/>
      <circle cx="48" cy="26" r="5.5"/>
      <path d="M20 50c1.5-10 6-15 12-15s10.5 5 12 15"/>
      <path d="M6 50c1-8 4.5-12 10-12 3 0 5.5 1.2 7.2 3.6"/>
      <path d="M58 50c-1-8-4.5-12-10-12-3 0-5.5 1.2-7.2 3.6"/>
    </svg>`;
  ...
  // RC160: navegação pelo menu Mais é controlada exclusivamente por routing-fix-v161.js.
