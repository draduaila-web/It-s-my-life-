...
/* ============================================================
   BERTH.A — SATÉLITES v156
   Reconstruído do zero como uma única camada autoritativa.
   ============================================================ */
(function(){
  const STYLE_ID='bertha-satellites-v156';
  ...
  function go(route,id){
    ...
    if(route==='satelites') renderSatellitesV156();
    else renderSatelliteProfileV156();
  }

  function renderSatellitesV156(){
    styles();
    ...
    document.querySelector('#s156Read')?.addEventListener('click',()=>{const x=events();x.forEach(e=>e.read=true);saveSatelliteOwnerEvents(x);renderSatellitesV156()});
  ...
  function renderSatelliteProfileV156(){
    styles();
  ...
  window.renderSatellitesV156=renderSatellitesV156;
  window.renderSatelliteProfileV156=renderSatelliteProfileV156;
  try{renderSatellites=renderSatellitesV156;window.renderSatellites=renderSatellitesV156}catch{}
  try{renderSatelliteDay=renderSatelliteProfileV156;window.renderSatelliteDay=renderSatelliteProfileV156}catch{}
  ...
  setTimeout(()=>{
    ...
    if(route==='satelites')renderSatellitesV156();
    if(route==='satelite')renderSatelliteProfileV156();
  },120);
})();
