...
/* RC141 — Premiações redesenhadas para corresponder ao esboço aprovado */
function rc141RewardBadge(kind='owner1',glyph='✦'){
  return `<span class="rc141-badge rc141-${kind}"><span class="rc141-badge-glow"></span><span class="rc141-badge-glyph">${escapeHtml(glyph)}</span></span>`;
}
function rc141OwnerGlyph(i,r){return r?.icon||['★','⌁','✦','❖'][i%4]}
function rc141KidGlyph(type){
  return type==='trophy'?'♛':type==='egg'?'✦':type==='skin'?'◈':type==='companion'?'●':'★'
}
function rc141RewardLabel(type){
  return type==='medal'?'Medalha':type==='egg'?'Cápsula':type==='trophy'?'Troféu':type==='skin'?'Skin':type==='companion'?'Companheiro':'Conquista'
}
function rc141RewardsCss(){
  if(document.getElementById('rc141-rewards-design'))return;
  const st=document.createElement('style');
  st.id='rc141-rewards-design';
  st.textContent=`
  html body .rewards-page{gap:14px!important;padding-bottom:22px!important}
  html body .rewards-hero{
    min-height:176px!important;padding:22px!important;display:flex!important;align-items:center!important;
    background:linear-gradient(135deg,rgba(249,215,226,.72) 0%,rgba(255,244,226,.80) 44%,rgba(219,235,252,.90) 100%)!important;
    border:1px solid rgba(170,157,177,.13)!important;box-shadow:0 12px 28px rgba(74,57,69,.05)!important
  }
  html body .rewards-hero .sat-hero-icon{display:none!important}
  html body .rewards-hero h2{font-size:29px!important;font-weight:400!important;line-height:1.05!important;letter-spacing:-.03em!important;max-width:460px!important}
  html body .rewards-hero p{font-size:13.5px!important;line-height:1.48!important;max-width:510px!important;font-weight:400!important}
  html body .rewards-tabs{gap:0!important;padding:4px!important;border-radius:20px!important;background:rgba(255,253,249,.76)!important}
  html body .rewards-tabs button{min-height:44px!important;border-radius:16px!important;font-size:12px!important;font-weight:400!important}
  html body .rewards-tabs button.active{background:#fffdfa!important;box-shadow:0 4px 15px rgba(74,57,69,.05)!important;color:#413b46!important}

  html body .rc141-section{padding:16px!important;border-radius:26px!important;background:rgba(255,253,249,.82)!important;border:1px solid rgba(126,115,132,.08)!important;box-shadow:0 10px 24px rgba(74,57,69,.035)!important}
  html body .rc141-section-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:13px}
  html body .rc141-section-head h3{margin:0!important;font-size:20px!important;font-weight:430!important;letter-spacing:-.02em!important;color:#3f3945!important}
  html body .rc141-section-head p{margin:4px 0 0!important;font-size:11.5px!important;line-height:1.42!important;color:#8a818b!important;font-weight:400!important}
  html body .rc141-more{border:1px solid rgba(126,115,132,.09)!important;background:#fffdfa!important;color:#79717d!important;border-radius:999px!important;min-height:34px!important;padding:0 12px!important;font-size:10.5px!important;font-weight:400!important}

  html body .rc141-owner-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px}
  html body .rc141-achievement{
    min-height:148px;padding:12px 9px;border-radius:20px;background:linear-gradient(155deg,#fffdfa,#fbf8f5)!important;
    border:1px solid rgba(126,115,132,.08)!important;text-align:center;display:grid;align-content:start;justify-items:center;gap:8px
  }
  html body .rc141-achievement strong{font-size:11px!important;line-height:1.22!important;font-weight:430!important;color:#47414b!important}
  html body .rc141-achievement small{font-size:9.5px!important;line-height:1.25!important;color:#938a95!important;font-weight:400!important}

  html body .rc141-badge{
    position:relative;width:66px;height:66px;border-radius:22px;display:grid;place-items:center;overflow:hidden;
    border:1px solid rgba(255,255,255,.75);box-shadow:inset 0 0 0 1px rgba(126,115,132,.06),0 8px 18px rgba(75,61,77,.08)
  }
  html body .rc141-badge:before{content:'';position:absolute;inset:7px;border-radius:17px;border:1px solid rgba(255,255,255,.64)}
  html body .rc141-badge-glow{position:absolute;width:46px;height:46px;border-radius:50%;background:rgba(255,255,255,.46);filter:blur(5px)}
  html body .rc141-badge-glyph{position:relative;z-index:2;font-size:29px;line-height:1;color:#fff;text-shadow:0 2px 8px rgba(74,57,69,.16)}
  html body .rc141-owner1{background:linear-gradient(145deg,#f0c9b8,#dcabbf 48%,#c9daf0)}
  html body .rc141-owner2{background:linear-gradient(145deg,#cbdff0,#cfd8ef 52%,#eadde9)}
  html body .rc141-owner3{background:linear-gradient(145deg,#f3c4a9,#e9a883 52%,#f4d4c1)}
  html body .rc141-owner4{background:linear-gradient(145deg,#d9eadf,#bcd8c7 52%,#e8eee7)}
  html body .rc141-kid1{background:linear-gradient(145deg,#ffd86d,#f2b84f 52%,#f6d79e)}
  html body .rc141-kid2{background:linear-gradient(145deg,#b9b8f4,#8e91e8 52%,#d0c9fb)}
  html body .rc141-kid3{background:linear-gradient(145deg,#9ed6f2,#69b7df 52%,#cae9f8)}
  html body .rc141-kid4{background:linear-gradient(145deg,#f5adbd,#de809a 52%,#f6cbd5)}
  html body .rc141-helper1{background:linear-gradient(145deg,#f5c4c8,#e4a0ad 52%,#f2d2cb)}
  html body .rc141-helper2{background:linear-gradient(145deg,#f4ddb0,#e9bf72 52%,#f8e9ca)}
  html body .rc141-helper3{background:linear-gradient(145deg,#d9eadf,#a9ccb7 52%,#e8f1e9)}
  html body .rc141-helper4{background:linear-gradient(145deg,#cbe0f4,#9fc3e6 52%,#e5eef9)}

  html body .rc141-kid-profile{
    display:grid;grid-template-columns:78px minmax(0,1fr) auto;gap:13px;align-items:center;padding:14px;
    border-radius:22px;background:linear-gradient(135deg,rgba(250,244,249,.94),rgba(243,247,252,.95));border:1px solid rgba(126,115,132,.08)
  }
  html body .rc141-kid-avatar{width:72px;height:72px;border-radius:24px;display:grid;place-items:center;background:linear-gradient(145deg,#f1e8f3,#e2eff8);color:#65728b}
  html body .rc141-kid-avatar svg{width:42px;height:42px}
  html body .rc141-kid-profile h4{margin:0!important;font-size:20px!important;font-weight:440!important;color:#423c47!important}
  html body .rc141-kid-profile p{margin:3px 0 9px!important;font-size:10.5px!important;color:#8a818b!important}
  html body .rc141-points{padding:8px 11px;border-radius:999px;background:#fff6df;color:#6b5b39;font-size:11px;font-weight:430;white-space:nowrap}
  html body .rc141-level{height:9px;border-radius:999px;background:#eee8ee;overflow:hidden}
  html body .rc141-level span{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,#a9cbe7,#d1b5e7,#e9b1bd)}

  html body .rc141-kid-awards{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin-top:10px}
  html body .rc141-kid-award{padding:10px 8px;border-radius:18px;background:#fffdfa;border:1px solid rgba(126,115,132,.08);display:grid;gap:5px;justify-items:center;text-align:center}
  html body .rc141-kid-award .rc141-badge{width:54px;height:54px;border-radius:18px}
  html body .rc141-kid-award .rc141-badge-glyph{font-size:24px}
  html body .rc141-kid-award strong{font-size:10.5px;font-weight:430;color:#4b4550}
  html body .rc141-kid-award small{font-size:9.5px;color:#8a818b}

  html body .kids-theme-box{margin-top:11px!important;background:#fffdfa!important}
  html body .kids-theme-options button{min-height:60px!important;padding:10px!important;font-size:10.5px!important;border-radius:16px!important}
  html body .kids-theme-options button.active{box-shadow:inset 0 0 0 1px rgba(95,108,142,.14),0 4px 12px rgba(74,57,69,.04)!important}

  html body .rc141-helper-preview{display:grid;grid-template-columns:64px minmax(0,1fr);gap:12px;align-items:center;padding:13px;border-radius:20px;background:#fffdfa;border:1px solid rgba(126,115,132,.08)}
  html body .rc141-helper-preview .rc141-badge{width:58px;height:58px;border-radius:19px}
  html body .rc141-helper-preview strong{font-size:14px;font-weight:430;color:#47414b}
  html body .rc141-helper-preview small{display:block;margin-top:4px;font-size:10.5px;line-height:1.35;color:#8a818b}
  html body .rc141-helper-icons{display:flex;gap:8px;margin-top:10px;flex-wrap:wrap}
  html body .rc141-helper-icons .rc141-badge{width:42px;height:42px;border-radius:14px}
  html body .rc141-helper-icons .rc141-badge-glyph{font-size:18px}

  html body .rc141-config-toggle{margin-top:12px;border-radius:18px;border:1px solid rgba(126,115,132,.08);overflow:hidden;background:#fffdfa}
  html body .rc141-config-toggle summary{list-style:none;cursor:pointer;padding:13px 14px;font-size:11.5px;color:#625a66;font-weight:430}
  html body .rc141-config-toggle summary::-webkit-details-marker{display:none}
  html body .rc141-config-toggle summary:after{content:'⌄';float:right;color:#8c8490}
  html body .rc141-config-toggle[open] summary:after{content:'⌃'}
  html body .rc141-config-body{display:grid;gap:10px;padding:0 12px 12px}

  html body .reward-config-card{border-radius:18px!important;background:#fff!important;padding:13px!important;box-shadow:none!important}
  html body .reward-config-head strong{font-weight:430!important}
  html body .reward-config-head small,.reward-config-card label{font-weight:400!important}
  html body .reward-config-actions button{font-weight:400!important}
  html body .recognition-history strong{font-weight:430!important}
  html body .recognition-history small{font-weight:400!important}

  @media(max-width:560px){
    html body .rc141-owner-grid{grid-template-columns:repeat(2,minmax(0,1fr))}
    html body .rc141-kid-profile{grid-template-columns:64px minmax(0,1fr)}
    html body .rc141-kid-avatar{width:60px;height:60px;border-radius:20px}
    html body .rc141-kid-profile .rc141-points{grid-column:2;justify-self:start}
    html body .rc141-kid-awards{grid-template-columns:repeat(2,minmax(0,1fr))}
  }
  `;
  document.head.appendChild(st);
}

function renderRewardsRC141(){
  ensureSatelliteStyles();ensureSatelliteIdentityV4();rewardsHubStyles();rewardsVisualRC140();rc141RewardsCss();
  const data=loadSatellites();
  const kids=(data.members||[]).filter(m=>m.status!=='removed'&&m.role==='kids');
  const adults=(data.members||[]).filter(m=>m.status!=='removed'&&m.role!=='kids');
  const owner=loadOwnerRewards(),presets=loadRecognitionPresets(),history=loadRecognitions();
  const kidsProgress=loadKidsProgress(),themeMap=loadKidsRewardThemes();

  const ownerConfig=owner.map((r,i)=>`
    <div class="reward-config-card" data-owner-reward="${i}">
      <div class="reward-config-head">
        <span class="reward-config-icon">${escapeHtml(r.icon||rc141OwnerGlyph(i,r))}</span>
        <div><strong>${escapeHtml(r.name)}</strong><small>${escapeHtml(r.description||'')}</small></div>
        <label class="reward-active"><input type="checkbox" data-or-active ${r.active!==false?'checked':''}>Ativa</label>
      </div>
      <div class="reward-form-grid">
        <label>Nome<input data-or-name value="${escapeHtml(r.name)}"></label>
        <label>Ícone<input data-or-icon maxlength="2" value="${escapeHtml(r.icon||rc141OwnerGlyph(i,r))}"></label>
        <label>Critério<select data-or-criterion>
          <option value="progress100" ${r.criterion==='progress100'?'selected':''}>Progresso em 100%</option>
          <option value="goal" ${r.criterion==='goal'?'selected':''}>Meta concluída</option>
          <option value="streak" ${r.criterion==='streak'?'selected':''}>Sequência de dias</option>
          <option value="cycle" ${r.criterion==='cycle'?'selected':''}>Ciclo concluído</option>
        </select></label>
        <label>Valor/meta<input type="number" min="1" data-or-value value="${Math.max(1,+r.value||1)}"></label>
        <label>Recorrência<select data-or-rec>
          <option value="once" ${r.recurrence==='once'?'selected':''}>Única</option>
          <option value="each" ${r.recurrence==='each'?'selected':''}>A cada conquista</option>
          <option value="weekly" ${r.recurrence==='weekly'?'selected':''}>Semanal</option>
          <option value="monthly" ${r.recurrence==='monthly'?'selected':''}>Mensal</option>
        </select></label>
        <label>Visual<input data-or-visual value="${escapeHtml(r.visual||'Selo BERTH.A')}"></label>
      </div>
      <label>Descrição<input data-or-desc value="${escapeHtml(r.description||'')}"></label>
    </div>
  `).join('');

  const ownerCards=owner.slice(0,4).map((r,i)=>`
    <div class="rc141-achievement">
      ${rc141RewardBadge('owner'+((i%4)+1),rc141OwnerGlyph(i,r))}
      <strong>${escapeHtml(r.name)}</strong>
      <small>${escapeHtml(r.description||'Conquista BERTH.A')}</small>
    </div>
  `).join('');

  const kidsHtml=kids.length?kids.map(m=>{
    const cfg=kidsRewardsFor(m.id),p=kidsProgress[m.id]||{season:0,lifetime:0,awards:[]},theme=themeMap[m.id]||'mist';
    const entries=Object.entries(cfg);
    const next=entries.filter(([,r])=>r.active!==false&&(+r.points||0)>(+p.season||0)).sort((a,b)=>(+a[1].points||0)-(+b[1].points||0))[0];
    const nextPts=next?Math.max(1,(+next[1].points||0)-(+p.season||0)):0;
    const max=Math.max(1,...entries.map(([,r])=>+r.points||1));
    const pct=Math.min(100,((+p.season||0)/max)*100);
    const awardTiles=entries.slice(0,4).map(([key,r],i)=>`
      <div class="rc141-kid-award">
        ${rc141RewardBadge('kid'+((i%4)+1),r.icon||rc141KidGlyph(r.type))}
        <strong>${rc141RewardLabel(r.type)}</strong>
        <small>${Math.max(1,+r.points||1)} pts</small>
      </div>
    `).join('');
    const config=entries.map(([key,r],i)=>`
      <div class="reward-config-card" data-kid-reward="${key}">
        <div class="reward-config-head">
          <span class="reward-config-icon">${escapeHtml(r.icon||rc141KidGlyph(r.type))}</span>
          <div><strong>${escapeHtml(r.name||'Conquista')}</strong><small>${rc141RewardLabel(r.type)}</small></div>
          <label class="reward-active"><input type="checkbox" data-kr-active ${r.active!==false?'checked':''}>Ativa</label>
        </div>
        <div class="reward-form-grid">
          <label>Nome<input data-kr-name value="${escapeHtml(r.name||'')}"></label>
          <label>Pontos<input type="number" min="1" max="9999" data-kr-points value="${Math.max(1,+r.points||1)}"></label>
          <label>Tipo<select data-kr-type>
            <option value="medal" ${r.type==='medal'?'selected':''}>Medalha</option>
            <option value="egg" ${r.type==='egg'?'selected':''}>Cápsula</option>
            <option value="trophy" ${r.type==='trophy'?'selected':''}>Troféu</option>
            <option value="skin" ${r.type==='skin'?'selected':''}>Skin</option>
            <option value="companion" ${r.type==='companion'?'selected':''}>Companheiro</option>
          </select></label>
          <label>Ícone<input data-kr-icon maxlength="2" value="${escapeHtml(r.icon||rc141KidGlyph(r.type))}"></label>
          <label>Recorrência<select data-kr-rec>
            <option value="once" ${r.recurrence==='once'?'selected':''}>Única</option>
            <option value="season" ${r.recurrence==='season'?'selected':''}>Por temporada</option>
            <option value="monthly" ${r.recurrence==='monthly'?'selected':''}>Mensal</option>
          </select></label>
          <label>Visual<input data-kr-visual value="${escapeHtml(r.visual||'Colecionável')}"></label>
        </div>
        <label>Descrição<input data-kr-desc value="${escapeHtml(r.description||'')}"></label>
        <div class="kid-reward-extra">
          <label>Ao desbloquear<select data-kr-unlock>
            <option value="badge" ${(r.unlock||'badge')==='badge'?'selected':''}>Registrar conquista</option>
            <option value="surprise" ${r.unlock==='surprise'?'selected':''}>Abrir surpresa</option>
            <option value="skin" ${r.unlock==='skin'?'selected':''}>Liberar skin/tema</option>
            <option value="accessory" ${r.unlock==='accessory'?'selected':''}>Liberar acessório</option>
            <option value="companion" ${r.unlock==='companion'?'selected':''}>Liberar personagem</option>
          </select></label>
          <label>Item liberado<input data-kr-item value="${escapeHtml(r.item||'')}" placeholder="Ex.: Skin Oceano"></label>
        </div>
      </div>
    `).join('');

    return `<section class="rc141-section rewards-kid" data-rewards-kid="${m.id}" data-kid-theme="${theme}">
      <div class="rc141-section-head"><div><h3>Conquistas de ${escapeHtml(m.name)}</h3><p>Acompanhe o progresso e personalize a coleção.</p></div></div>
      <div class="rc141-kid-profile">
        <span class="rc141-kid-avatar">${satelliteAvatarIcon(m.avatarKey||'son')}</span>
        <div><h4>${escapeHtml(m.name)}</h4><p>${next?`${nextPts} pontos para ${escapeHtml(next[1].name||'a próxima conquista')}`:'Todas as metas atuais alcançadas.'}</p><div class="rc141-level"><span style="width:${pct}%"></span></div></div>
        <span class="rc141-points">✦ ${+p.season||0} pontos</span>
      </div>
      <div class="rc141-kid-awards">${awardTiles}</div>
      <div class="kids-theme-box">
        <div><strong>Temas de recompensa</strong><small>Personalize as cores do universo de ${escapeHtml(m.name)}.</small></div>
        <div class="kids-theme-options">
          <button type="button" data-theme="mist" class="${theme==='mist'?'active':''}">Azul Neblina</button>
          <button type="button" data-theme="ocean" class="${theme==='ocean'?'active':''}">Oceano</button>
          <button type="button" data-theme="space" class="${theme==='space'?'active':''}">Espaço</button>
          <button type="button" data-theme="forest" class="${theme==='forest'?'active':''}">Floresta</button>
          <button type="button" data-theme="solar" class="${theme==='solar'?'active':''}">Solar</button>
          <button type="button" data-theme="coral" class="${theme==='coral'?'active':''}">Coral</button>
        </div>
      </div>
      <details class="rc141-config-toggle"><summary>Configurar regras e recompensas</summary><div class="rc141-config-body">${config}<div class="reward-config-actions"><button class="saveKidRewards">Salvar premiações</button></div></div></details>
    </section>`;
  }).join(''):`<section class="rc141-section"><div class="sat-empty">Cadastre um satélite como Kids para configurar premiações.</div></section>`;

  const helperCards=presets.slice(0,4).map((r,i)=>rc141RewardBadge('helper'+((i%4)+1),r.icon||['♡','☆','✦','◈'][i%4])).join('');
  const helperConfig=presets.map((r,i)=>`
    <div class="reward-config-card" data-rec-preset="${i}">
      <div class="reward-config-head"><span class="reward-config-icon">${escapeHtml(r.icon||'✦')}</span><div><strong>${escapeHtml(r.name||'Reconhecimento')}</strong><small>${escapeHtml(r.message||'')}</small></div><label class="reward-active"><input type="checkbox" data-rp-active ${r.active!==false?'checked':''}>Ativo</label></div>
      <div class="reward-form-grid"><label>Símbolo<input data-rp-icon maxlength="2" value="${escapeHtml(r.icon||'✦')}"></label><label>Nome<input data-rp-name value="${escapeHtml(r.name||'')}"></label></div>
      <label>Mensagem<input data-rp-message value="${escapeHtml(r.message||'')}"></label>
    </div>
  `).join('');

  app.innerHTML=`<div class="sat-page rewards-page">
    <section class="sat-hero sat-ideal-hero rewards-hero"><div class="sat-hero-copy"><div class="eyebrow">PREMIAÇÕES</div><h2>Você desempenha.<br>A BERTH.A reconhece.</h2><p>Conquistas para você. Gamificação para Kids. Reconhecimento para quem caminha junto.</p></div></section>
    <div class="rewards-tabs"><button class="active" data-reward-tab="owner">Owner</button><button data-reward-tab="kids">Kids</button><button data-reward-tab="helpers">Reconhecimentos</button></div>

    <section class="rewards-pane" data-reward-pane="owner">
      <section class="rc141-section">
        <div class="rc141-section-head"><div><h3>Minhas conquistas</h3><p>Pequenas vitórias, grandes movimentos.</p></div></div>
        <div class="rc141-owner-grid">${ownerCards}</div>
        <details class="rc141-config-toggle"><summary>Personalizar conquistas</summary><div class="rc141-config-body">${ownerConfig}<div class="reward-config-actions"><button id="saveOwnerRewards">Salvar conquistas</button></div></div></details>
      </section>
    </section>

    <section class="rewards-pane" data-reward-pane="kids" hidden>${kidsHtml}</section>

    <section class="rewards-pane" data-reward-pane="helpers" hidden>
      <section class="rc141-section">
        <div class="rc141-section-head"><div><h3>Reconhecimentos</h3><p>Valorize quem caminha com você.</p></div></div>
        <div class="rc141-helper-preview">${rc141RewardBadge('helper1',presets[0]?.icon||'♡')}<div><strong>${escapeHtml(presets[0]?.name||'Ajuda incrível')}</strong><small>${escapeHtml(presets[0]?.message||'A BERTH.A registrou: essa ajuda fez tudo mais leve.')}</small><div class="rc141-helper-icons">${helperCards}</div></div></div>
        <details class="rc141-config-toggle"><summary>Personalizar reconhecimentos</summary><div class="rc141-config-body">${helperConfig}<div class="reward-config-actions"><button id="saveRecognitionPresets">Salvar reconhecimentos</button></div></div></details>
      </section>
      ${adults.length?`<section class="rc141-section"><div class="rc141-section-head"><div><h3>Helpers da sua rede</h3><p>Reconhecimentos recebidos por cada satélite adulto.</p></div></div><div class="recognition-history">${adults.map(m=>{const count=history.filter(x=>String(x.toId)===String(m.id)).length;return `<div class="item"><strong>${escapeHtml(m.name)}</strong><small>${count} reconhecimento${count===1?'':'s'} recebido${count===1?'':'s'}</small></div>`}).join('')}</div></section>`:''}
    </section>
  </div>`;

  document.querySelectorAll('[data-reward-tab]').forEach(btn=>btn.onclick=()=>{
    const tab=btn.dataset.rewardTab;
    document.querySelectorAll('[data-reward-tab]').forEach(x=>x.classList.toggle('active',x===btn));
    document.querySelectorAll('[data-reward-pane]').forEach(p=>p.hidden=p.dataset.rewardPane!==tab);
  });

  document.querySelectorAll('[data-rewards-kid]').forEach(section=>{
    const mid=section.dataset.rewardsKid;
    section.querySelectorAll('[data-theme]').forEach(b=>b.onclick=()=>{
      const all=loadKidsRewardThemes();all[mid]=b.dataset.theme;saveKidsRewardThemes(all);
      section.dataset.kidTheme=b.dataset.theme;
      section.querySelectorAll('[data-theme]').forEach(x=>x.classList.toggle('active',x===b));
    });
    section.querySelector('.saveKidRewards')?.addEventListener('click',e=>{
      const all=loadKidsRewards(),current=kidsRewardsFor(mid);
      section.querySelectorAll('[data-kid-reward]').forEach(row=>{
        const key=row.dataset.kidReward;
        current[key]={...current[key],
          ...
          points:Math.max(1,+row.querySelector('[data-kr-points]').value||1),
          type:row.querySelector('[data-kr-type]').value,
          icon:row.querySelector('[data-kr-icon]').value.trim()||rc141KidGlyph(row.querySelector('[data-kr-type]').value),
          recurrence:row.querySelector('[data-kr-rec]').value,
          visual:row.querySelector('[data-kr-visual]').value.trim(),
          description:row.querySelector('[data-kr-desc]').value.trim(),
          unlock:row.querySelector('[data-kr-unlock]')?.value||'badge',
          item:row.querySelector('[data-kr-item]')?.value.trim()||'',
          active:row.querySelector('[data-kr-active]').checked
        };
      });
      all[mid]=current;saveKidsRewards(all);
      const b=e.currentTarget;b.textContent='Salvo';setTimeout(()=>b.textContent='Salvar premiações',900);
    });
  });

  document.querySelector('#saveOwnerRewards')?.addEventListener('click',e=>{
    const current=loadOwnerRewards();
    const vals=[...document.querySelectorAll('[data-owner-reward]')].map((row,i)=>({...current[i],
      name:row.querySelector('[data-or-name]').value.trim()||current[i].name,
      icon:row.querySelector('[data-or-icon]').value.trim()||current[i].icon||'✦',
      criterion:row.querySelector('[data-or-criterion]').value,
      value:Math.max(1,+row.querySelector('[data-or-value]').value||1),
      recurrence:row.querySelector('[data-or-rec]').value,
      visual:row.querySelector('[data-or-visual]').value.trim(),
      description:row.querySelector('[data-or-desc]').value.trim(),
      active:row.querySelector('[data-or-active]').checked
    }));
    saveOwnerRewards(vals);e.currentTarget.textContent='Salvo';setTimeout(()=>e.currentTarget.textContent='Salvar conquistas',900);
  });

  document.querySelector('#saveRecognitionPresets')?.addEventListener('click',e=>{
    const base=loadRecognitionPresets();
    const vals=[...document.querySelectorAll('[data-rec-preset]')].map((row,i)=>({...base[i],
      icon:row.querySelector('[data-rp-icon]').value.trim()||base[i].icon||'✦',
      name:row.querySelector('[data-rp-name]').value.trim()||base[i].name,
      message:row.querySelector('[data-rp-message]').value.trim(),
      active:row.querySelector('[data-rp-active]').checked
    }));
    saveRecognitionPresets(vals);e.currentTarget.textContent='Salvo';setTimeout(()=>e.currentTarget.textContent='Salvar reconhecimentos',900);
  });
}

renderUniversalRewards=renderRewardsRC141;
renderKidsRewards=renderRewardsRC141;


/* RC142 — garante que Premiações seja redesenhado após todos os overrides carregarem.
   O primeiro render do app acontece antes dos patches RC140/RC141. */
(function(){
  const refreshRewards=()=>{
    const route=(location.hash||'').replace('#','').trim();
    if(route==='premiacoes'){
      try{ renderRewardsRC141(); }catch(err){ console.error('RC142 Premiações',err); }
    }
  };

  // Render imediato após a definição final do módulo.
  requestAnimationFrame(()=>requestAnimationFrame(refreshRewards));

  // Safari/PWA: reforço depois das camadas posteriores do runtime.
  setTimeout(refreshRewards,80);
  setTimeout(refreshRewards,260);

  // Mesmo tocando em Premiações quando o hash já é #premiacoes, refaz a tela.
  document.addEventListener('click',e=>{
    const a=e.target.closest?.('a[href="#premiacoes"],[data-module-route="premiacoes"],[data-route="premiacoes"]');
    if(a) setTimeout(refreshRewards,0);
  });
})();


/* RC143 — Premiações fiel ao esboço aprovado:
   cards visuais gamificados + cores personalizáveis por tema + configurações recolhidas. */
function rc143Icon(key,uid='x'){
  const id=`g_${key}_${uid}`.replace(/[^a-zA-Z0-9_]/g,'');
  const svg=(body)=>`<svg viewBox="0 0 72 72" aria-hidden="true" class="rc143-svg">${body}</svg>`;
  const grad=(a,b,c='')=>`<defs><linearGradient id="${id}" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="${a}"/><stop offset="100%" stop-color="${b}"/></linearGradient>${c}</defs>`;
  switch(key){
    case 'medal':
      return svg(`${grad('#f6c0cb','#d798b7')}<circle cx="36" cy="34" r="22" fill="url(#${id})"/><circle cx="36" cy="34" r="15" fill="#fff4e9" opacity=".72"/><path d="M36 22l3.7 7.5 8.3 1.2-6 5.8 1.4 8.2-7.4-3.9-7.4 3.9 1.4-8.2-6-5.8 8.3-1.2z" fill="#ffd774"/><path d="M25 53l-2 13 13-7 13 7-2-13" fill="#e5adc1" opacity=".85"/></svg>`);
    case 'mountain':
      return svg(`${grad('#dceafe','#a8c5ef')}<path d="M9 57l17-26 9 13 9-21 19 34z" fill="url(#${id})"/><path d="M26 31l5 7 4-6 4 7 5-8" fill="#fff" opacity=".75"/><path d="M45 21v-9h12l-4 4 4 4H45" fill="#e7a66f"/><path d="M45 12v18" stroke="#7c8fb3" stroke-width="2" stroke-linecap="round"/></svg>`);
    case 'flame':
      return svg(`${grad('#ffb17c','#ec7959')}<path d="M39 8c3 13-9 16-6 27 2 7 8 6 11 1 4 8 4 14 0 20-4 7-15 11-24 5C8 53 12 37 21 28c1 8 5 10 8 7 5-4 3-13 10-27z" fill="url(#${id})"/><path d="M34 36c3 5 2 11-2 15-5 5-11 1-10-5 .5-3 3-6 7-10 0 5 2 7 5 0z" fill="#ffe1b4"/></svg>`);
    case 'leaf':
      return svg(`${grad('#b9dfc5','#6bb48d')}<path d="M35 60V37" stroke="#6a9c7d" stroke-width="3" stroke-linecap="round"/><path d="M35 40C19 38 11 26 16 13c15 1 25 11 19 27z" fill="url(#${id})"/><path d="M37 46c2-16 13-24 26-21 0 15-10 25-26 21z" fill="#83c19f"/><path d="M35 40c-5-7-10-12-15-16M37 46c7-5 13-9 19-11" stroke="#e8f7ec" stroke-width="1.7" stroke-linecap="round"/></svg>`);
    case 'telescope':
      return svg(`${grad('#8fc7ff','#7b79e8')}<g transform="rotate(-18 36 36)"><rect x="18" y="20" width="34" height="14" rx="7" fill="url(#${id})"/><circle cx="54" cy="27" r="8" fill="#9b8deb"/><circle cx="54" cy="27" r="4" fill="#d9ddff"/><rect x="13" y="24" width="8" height="6" rx="3" fill="#cfd7ff"/></g><path d="M34 39l-8 20M37 39l8 20M35.5 39v20" stroke="#7e82a8" stroke-width="3" stroke-linecap="round"/><path d="M13 17l2 4 4 2-4 2-2 4-2-4-4-2 4-2zM60 12l1.5 3 3 1.5-3 1.5-1.5 3-1.5-3-3-1.5 3-1.5z" fill="#ffd16d"/></svg>`);
    case 'books':
      return svg(`${grad('#f6b4b5','#e88492')}<rect x="14" y="17" width="42" height="10" rx="4" fill="url(#${id})"/><rect x="10" y="30" width="46" height="11" rx="4" fill="#7fa6e9"/><rect x="16" y="44" width="40" height="11" rx="4" fill="#e8b67d"/><path d="M20 17v10M17 30v11M24 44v11" stroke="#fff" opacity=".55" stroke-width="2"/></svg>`);
    case 'shield':
      return svg(`${grad('#8ed2ff','#3f9ae5')}<path d="M36 8l23 8v17c0 14-9 25-23 31C22 58 13 47 13 33V16z" fill="url(#${id})"/><path d="M36 15l16 6v13c0 10-6 18-16 23-10-5-16-13-16-23V21z" fill="#bce5ff" opacity=".45"/><path d="M36 43S24 36 24 29c0-7 9-9 12-3 3-6 12-4 12 3 0 7-12 14-12 14z" fill="#fff1ef"/></svg>`);
    case 'gem':
      return svg(`${grad('#ff9fb6','#d96e9f')}<path d="M36 8l24 14-6 29-18 13-18-13-6-29z" fill="url(#${id})"/><path d="M21 24h30L36 49z" fill="#ffd9e6" opacity=".65"/><path d="M21 24l15-9 15 9-15 25z" fill="none" stroke="#fff" stroke-width="1.5" opacity=".55"/></svg>`);
    case 'heart':
      return svg(`${grad('#f7b0bd','#df7995')}<path d="M36 58S12 45 12 27c0-9 7-15 15-15 6 0 9 3 9 7 0-4 4-7 10-7 8 0 14 6 14 15 0 18-24 31-24 31z" fill="url(#${id})"/><path d="M27 18c-5 1-8 5-8 10" fill="none" stroke="#fff" stroke-width="3" stroke-linecap="round" opacity=".65"/></svg>`);
    case 'handshake':
      return svg(`${grad('#d4b4ef','#b991da')}<path d="M11 34l12-12 9 5 8-4 17 15-13 15-9-5-8 6L11 41z" fill="url(#${id})"/><path d="M24 34l8 7 8-8M31 47l5 4M19 43l5 4" stroke="#fff" stroke-width="2.4" stroke-linecap="round" opacity=".8"/></svg>`);
    case 'group':
      return svg(`${grad('#a9d4ff','#78aee8')}<circle cx="27" cy="25" r="8" fill="url(#${id})"/><circle cx="48" cy="28" r="7" fill="#86b9ec"/><path d="M12 56c1-11 7-17 15-17 9 0 15 6 16 17M39 56c1-8 5-13 11-13 6 0 10 5 11 13" fill="none" stroke="#6999c7" stroke-width="5" stroke-linecap="round"/></svg>`);
    case 'star':
    default:
      return svg(`${grad('#ffd983','#f0b254')}<path d="M36 8l8.1 16.3L62 27l-13 12.6L52 58l-16-8.4L20 58l3-18.4L10 27l17.9-2.7z" fill="url(#${id})"/><path d="M36 16l5 10 11 1.5-8 7.8 2 11-10-5.2-10 5.2 2-11-8-7.8 11-1.5z" fill="#fff" opacity=".3"/></svg>`);
  }
}
function rc143ThemeMeta(theme){
  const map={
    mist:{name:'Azul Neblina',class:'mist'},
    ocean:{name:'Oceano',class:'ocean'},
    space:{name:'Espaço',class:'space'},
    forest:{name:'Floresta',class:'forest'},
    solar:{name:'Solar',class:'solar'},
    coral:{name:'Coral',class:'coral'}
  };
  return map[theme]||map.mist;
}
function rc143RewardsStyles(){
  if(document.getElementById('rc143-rewards-design'))return;
  const st=document.createElement('style');
  st.id='rc143-rewards-design';
  st.textContent=`
    html body .rc143-page{display:grid;gap:14px;padding-bottom:24px}
    html body .rc143-hero{min-height:176px!important;padding:22px!important;display:flex!important;align-items:center!important;overflow:hidden!important;position:relative!important;background:linear-gradient(135deg,rgba(249,214,225,.74),rgba(255,245,226,.82) 45%,rgba(221,236,252,.92))!important}
    html body .rc143-hero:after{content:'';position:absolute;right:-22px;bottom:-60px;width:225px;height:180px;border-radius:50%;background:radial-gradient(ellipse at center,rgba(255,255,255,.82),rgba(214,231,249,.42) 45%,rgba(255,255,255,0) 70%);pointer-events:none}
    html body .rc143-hero h2{font-size:29px!important;font-weight:400!important;line-height:1.05!important;letter-spacing:-.03em!important;color:#3f3945!important}
    html body .rc143-hero p{font-size:13.5px!important;line-height:1.48!important;font-weight:400!important;color:#756d78!important;max-width:500px!important}
    html body .rc143-tabs{display:grid;grid-template-columns:repeat(3,1fr);gap:0;padding:4px;border-radius:20px;background:rgba(255,253,249,.78);border:1px solid rgba(126,115,132,.08)}
    html body .rc143-tabs button{min-height:44px;border:0;border-radius:16px;background:transparent;color:#77707c;font-size:12px;font-weight:400}
    html body .rc143-tabs button.active{background:#fffdfa;color:#403945;box-shadow:0 4px 15px rgba(74,57,69,.05)}
    html body .rc143-section{padding:16px;border-radius:26px;background:rgba(255,253,249,.84);border:1px solid rgba(126,115,132,.08);box-shadow:0 10px 24px rgba(74,57,69,.035)}
    html body .rc143-section-head{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:13px}
    html body .rc143-section-head h3{margin:0;font-size:20px;font-weight:430;letter-spacing:-.02em;color:#3f3945}
    html body .rc143-section-head p{margin:4px 0 0;font-size:11.5px;line-height:1.4;color:#8a818b;font-weight:400}
    html body .rc143-more{border:1px solid rgba(126,115,132,.09);background:#fffdfa;color:#79717d;border-radius:999px;min-height:34px;padding:0 12px;font-size:10.5px;font-weight:400}
    html body .rc143-owner-grid,html body .rc143-kids-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px}
    html body .rc143-card{min-height:154px;padding:11px 8px;border-radius:20px;background:linear-gradient(155deg,#fffdfa,#fbf8f5);border:1px solid rgba(126,115,132,.08);display:grid;align-content:start;justify-items:center;gap:7px;text-align:center}
    html body .rc143-iconbox{width:72px;height:72px;border-radius:22px;display:grid;place-items:center;background:linear-gradient(145deg,#fff9f4,#f2f6fb);border:1px solid rgba(255,255,255,.76);box-shadow:inset 0 0 0 1px rgba(126,115,132,.05),0 8px 18px rgba(75,61,77,.08);overflow:hidden}
    html body .rc143-svg{width:62px;height:62px;display:block}
    html body .rc143-card strong{font-size:10.8px;line-height:1.22;font-weight:430;color:#47414b}
    html body .rc143-card small{font-size:9.5px;line-height:1.28;font-weight:400;color:#938a95}
    html body .rc143-kids-grid .rc143-card{min-height:166px}
    html body .rc143-kids-grid .rc143-iconbox{width:78px;height:78px}
    html body .rc143-kids-grid .rc143-svg{width:68px;height:68px}
    html body .rc143-theme-box{margin-top:11px;padding:13px;border-radius:19px;background:#fffdfa;border:1px solid rgba(126,115,132,.08)}
    html body .rc143-theme-head{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:9px}
    html body .rc143-theme-head strong{font-size:12.5px;font-weight:430;color:#4b4550}
    html body .rc143-theme-head small{display:block;margin-top:2px;font-size:10.5px;color:#8a818b}
    html body .rc143-themes{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}
    html body .rc143-theme{min-height:56px;border-radius:16px;border:1px solid rgba(126,115,132,.10);padding:9px 10px;text-align:left;font-size:10.5px;color:#514b57;font-weight:400;position:relative;overflow:hidden}
    html body .rc143-theme.active:after{content:'✓';position:absolute;right:8px;top:7px;width:18px;height:18px;border-radius:50%;display:grid;place-items:center;background:#cc8cab;color:white;font-size:11px}
    html body .rc143-theme.mist{background:linear-gradient(135deg,#f4e6ef,#e2eef9)}
    html body .rc143-theme.ocean{background:linear-gradient(135deg,#dceefa,#bcdff1)}
    html body .rc143-theme.space{background:linear-gradient(135deg,#6f6796,#3f4478);color:white}
    html body .rc143-theme.forest{background:linear-gradient(135deg,#e4f1e6,#c8dfcf)}
    html body .rc143-theme.solar{background:linear-gradient(135deg,#fff1ce,#f5dca6)}
    html body .rc143-theme.coral{background:linear-gradient(135deg,#f9ded8,#efc9cb)}
    html body .rc143-recognition{display:grid;grid-template-columns:76px minmax(0,1fr) auto;gap:12px;align-items:center;padding:14px;border-radius:21px;background:#fffdfa;border:1px solid rgba(126,115,132,.08)}
    html body .rc143-recognition .rc143-iconbox{width:66px;height:66px;border-radius:20px}
    html body .rc143-recognition .rc143-svg{width:56px;height:56px}
    html body .rc143-recognition strong{font-size:14px;font-weight:430;color:#47414b}
    html body .rc143-recognition p{margin:3px 0 0;font-size:10.5px;line-height:1.4;color:#8a818b}
    html body .rc143-date{padding:7px 10px;border-radius:999px;background:#fff7f1;border:1px solid rgba(126,115,132,.08);font-size:9.5px;color:#8a818b}
    html body .rc143-recog-icons{grid-column:2/4;display:flex;gap:8px;flex-wrap:wrap;margin-top:2px}
    html body .rc143-mini{width:42px;height:42px;border-radius:14px;display:grid;place-items:center;background:#fff7f3;border:1px solid rgba(126,115,132,.08)}
    html body .rc143-mini .rc143-svg{width:34px;height:34px}
    html body .rc143-config{margin-top:12px;border-radius:18px;border:1px solid rgba(126,115,132,.08);overflow:hidden;background:#fffdfa}
    html body .rc143-config summary{list-style:none;padding:13px 14px;cursor:pointer;font-size:11.5px;font-weight:430;color:#625a66}
    html body .rc143-config summary::-webkit-details-marker{display:none}
    html body .rc143-config summary:after{content:'⌄';float:right;color:#8c8490}
    html body .rc143-config[open] summary:after{content:'⌃'}
    html body .rc143-config-body{display:grid;gap:10px;padding:0 12px 12px}
    html body .reward-config-card{border-radius:18px!important;background:#fff!important;padding:13px!important;box-shadow:none!important}
    html body .reward-config-head strong{font-weight:430!important}
    html body .reward-config-head small,html body .reward-config-card label{font-weight:400!important}
    @media(max-width:560px){
      html body .rc143-owner-grid,html body .rc143-kids-grid{grid-template-columns:repeat(2,minmax(0,1fr))}
      html body .rc143-themes{grid-template-columns:repeat(2,minmax(0,1fr))}
      html body .rc143-recognition{grid-template-columns:66px minmax(0,1fr)}
      html body .rc143-date{grid-column:2;justify-self:start}
      html body .rc143-recog-icons{grid-column:1/3}
    }
  `;
  document.head.appendChild(st);
}

function renderRewardsRC143(){
  ensureSatelliteStyles();ensureSatelliteIdentityV4();rewardsHubStyles();rc143RewardsStyles();
  const data=loadSatellites();
  const kids=(data.members||[]).filter(m=>m.status!=='removed'&&m.role==='kids');
  const owner=loadOwnerRewards();
  const presets=loadRecognitionPresets();
  const themes=loadKidsRewardThemes();
  const firstKid=kids[0];
  const activeTheme=firstKid?(themes[firstKid.id]||'mist'):'mist';

  const ownerVisuals=[
    {icon:'medal',title:'1 semana consistente',sub:'Há 2 dias'},
    {icon:'mountain',title:'Rotina em dia',sub:'Há 1 semana'},
    {icon:'flame',title:'Foco de 30 dias',sub:'Há 3 semanas'},
    {icon:'leaf',title:'Escolhas mais conscientes',sub:'Há 1 mês'}
  ];
  const kidsVisuals=[
    {icon:'telescope',title:'Explorador',sub:'Curioso por natureza'},
    {icon:'books',title:'Super Leitor',sub:'3 livros lidos'},
    {icon:'shield',title:'Boa Escolha',sub:'Atitude incrível'},
    {icon:'gem',title:'Coração Gentil',sub:'Ajudou alguém'}
  ];

  const ownerConfig=owner.map((r,i)=>`
    <div class="reward-config-card" data-owner-reward="${i}">
      <div class="reward-config-head"><span class="reward-config-icon">${escapeHtml(r.icon||'✦')}</span><div><strong>${escapeHtml(r.name)}</strong><small>${escapeHtml(r.description||'')}</small></div><label class="reward-active"><input type="checkbox" data-or-active ${r.active!==false?'checked':''}>Ativa</label></div>
      <div class="reward-form-grid">
        <label>Nome<input data-or-name value="${escapeHtml(r.name)}"></label>
        <label>Ícone<input data-or-icon maxlength="2" value="${escapeHtml(r.icon||'✦')}"></label>
        <label>Critério<select data-or-criterion><option value="progress100" ${r.criterion==='progress100'?'selected':''}>Progresso em 100%</option><option value="goal" ${r.criterion==='goal'?'selected':''}>Meta concluída</option><option value="streak" ${r.criterion==='streak'?'selected':''}>Sequência de dias</option><option value="cycle" ${r.criterion==='cycle'?'selected':''}>Ciclo concluído</option></select></label>
        <label>Valor/meta<input type="number" min="1" data-or-value value="${Math.max(1,+r.value||1)}"></label>
        <label>Recorrência<select data-or-rec><option value="once" ${r.recurrence==='once'?'selected':''}>Única</option><option value="each" ${r.recurrence==='each'?'selected':''}>A cada conquista</option><option value="weekly" ${r.recurrence==='weekly'?'selected':''}>Semanal</option><option value="monthly" ${r.recurrence==='monthly'?'selected':''}>Mensal</option></select></label>
        <label>Visual<input data-or-visual value="${escapeHtml(r.visual||'Selo BERTH.A')}"></label>
      </div>
      <label>Descrição<input data-or-desc value="${escapeHtml(r.description||'')}"></label>
    </div>`).join('');

  const kidsConfig=firstKid?Object.entries(kidsRewardsFor(firstKid.id)).map(([key,r])=>`
    <div class="reward-config-card" data-kid-reward="${key}">
      <div class="reward-config-head"><span class="reward-config-icon">${escapeHtml(r.icon||'★')}</span><div><strong>${escapeHtml(r.name||'Conquista')}</strong><small>${escapeHtml(r.type||'medal')}</small></div><label class="reward-active"><input type="checkbox" data-kr-active ${r.active!==false?'checked':''}>Ativa</label></div>
      <div class="reward-form-grid">
        <label>Nome<input data-kr-name value="${escapeHtml(r.name||'')}"></label>
        <label>Pontos<input type="number" min="1" data-kr-points value="${Math.max(1,+r.points||1)}"></label>
        <label>Tipo<select data-kr-type><option value="medal" ${r.type==='medal'?'selected':''}>Medalha</option><option value="egg" ${r.type==='egg'?'selected':''}>Cápsula</option><option value="trophy" ${r.type==='trophy'?'selected':''}>Troféu</option><option value="skin" ${r.type==='skin'?'selected':''}>Skin</option><option value="companion" ${r.type==='companion'?'selected':''}>Companheiro</option></select></label>
        <label>Ícone<input data-kr-icon maxlength="2" value="${escapeHtml(r.icon||'★')}"></label>
        <label>Recorrência<select data-kr-rec><option value="once" ${r.recurrence==='once'?'selected':''}>Única</option><option value="season" ${r.recurrence==='season'?'selected':''}>Por temporada</option><option value="monthly" ${r.recurrence==='monthly'?'selected':''}>Mensal</option></select></label>
        <label>Visual<input data-kr-visual value="${escapeHtml(r.visual||'Colecionável')}"></label>
      </div>
      <label>Descrição<input data-kr-desc value="${escapeHtml(r.description||'')}"></label>
      <div class="kid-reward-extra"><label>Ao desbloquear<select data-kr-unlock><option value="badge" ${(r.unlock||'badge')==='badge'?'selected':''}>Registrar conquista</option><option value="surprise" ${r.unlock==='surprise'?'selected':''}>Abrir surpresa</option><option value="skin" ${r.unlock==='skin'?'selected':''}>Liberar skin/tema</option><option value="accessory" ${r.unlock==='accessory'?'selected':''}>Liberar acessório</option><option value="companion" ${r.unlock==='companion'?'selected':''}>Liberar personagem</option></select></label><label>Item liberado<input data-kr-item value="${escapeHtml(r.item||'')}" placeholder="Ex.: Skin Oceano"></label></div>
    </div>`).join(''):'';

  const recognitionConfig=presets.map((r,i)=>`
    <div class="reward-config-card" data-rec-preset="${i}">
      <div class="reward-config-head"><span class="reward-config-icon">${escapeHtml(r.icon||'✦')}</span><div><strong>${escapeHtml(r.name||'Reconhecimento')}</strong><small>${escapeHtml(r.message||'')}</small></div><label class="reward-active"><input type="checkbox" data-rp-active ${r.active!==false?'checked':''}>Ativo</label></div>
      <div class="reward-form-grid"><label>Símbolo<input data-rp-icon maxlength="2" value="${escapeHtml(r.icon||'✦')}"></label><label>Nome<input data-rp-name value="${escapeHtml(r.name||'')}"></label></div>
      <label>Mensagem<input data-rp-message value="${escapeHtml(r.message||'')}"></label>
  ...
  app.innerHTML=`<div class="rc143-page">
    <section class="sat-hero sat-ideal-hero rc143-hero"><div class="sat-hero-copy"><div class="eyebrow">PREMIAÇÕES</div><h2>Você desempenha.<br>A BERTH.A reconhece.</h2><p>Conquistas para você. Gamificação para Kids. Reconhecimento para quem caminha junto.</p></div></section>

    <div class="rc143-tabs">
      <button class="active" data-rc143-jump="owner">Owner</button>
      <button data-rc143-jump="kids">Kids</button>
      <button data-rc143-jump="helpers">Reconhecimentos</button>
    </div>

    <section class="rc143-section" id="rc143Owner">
      <div class="rc143-section-head"><div><h3>Minhas conquistas</h3><p>Pequenas vitórias, grandes movimentos. Continue assim!</p></div><button class="rc143-more" type="button">Ver todas ›</button></div>
      <div class="rc143-owner-grid">
        ${ownerVisuals.map((x,i)=>`<div class="rc143-card"><span class="rc143-iconbox">${rc143Icon(x.icon,'o'+i)}</span><strong>${x.title}</strong><small>${x.sub}</small></div>`).join('')}
      </div>
      <details class="rc143-config"><summary>Personalizar conquistas</summary><div class="rc143-config-body">${ownerConfig}<div class="reward-config-actions"><button id="saveOwnerRewards">Salvar conquistas</button></div></div></details>
    </section>

    <section class="rc143-section" id="rc143Kids">
      <div class="rc143-section-head"><div><h3>Conquistas dos Kids</h3><p>Aprendizado, autonomia e momentos especiais.</p></div><button class="rc143-more" type="button">Ver todas ›</button></div>
      <div class="rc143-kids-grid">
        ${kidsVisuals.map((x,i)=>`<div class="rc143-card"><span class="rc143-iconbox">${rc143Icon(x.icon,'k'+i)}</span><strong>${x.title}</strong><small>${x.sub}</small></div>`).join('')}
      </div>
      <div class="rc143-theme-box">
        <div class="rc143-theme-head"><div><strong>Temas de recompensa</strong><small>Personalize a coleção dos Kids</small></div><span>›</span></div>
        <div class="rc143-themes">
          ${['mist','ocean','space','forest','solar','coral'].map(t=>{const m=rc143ThemeMeta(t);return `<button type="button" class="rc143-theme ${m.class} ${t===activeTheme?'active':''}" data-rc143-theme="${t}">${m.name}</button>`}).join('')}
        </div>
      </div>
      ${firstKid?`<details class="rc143-config"><summary>Configurar premiações de ${escapeHtml(firstKid.name)}</summary><div class="rc143-config-body">${kidsConfig}<div class="reward-config-actions"><button id="saveKidRewards143">Salvar premiações</button></div></div></details>`:`<div class="sat-empty" style="margin-top:12px">Cadastre um satélite como Kids para configurar regras e pontuação.</div>`}
    </section>

    <section class="rc143-section" id="rc143Helpers">
      <div class="rc143-section-head"><div><h3>Reconhecimentos</h3><p>Valorize quem caminha com você.</p></div><button class="rc143-more" type="button">Ver todos ›</button></div>
      <div class="rc143-recognition">
        <span class="rc143-iconbox">${rc143Icon('heart','rh')}</span>
        <div><strong>Ajuda incrível</strong><p>A BERTH.A registrou: essa ajuda fez tudo mais leve.</p></div>
        <span class="rc143-date">12 abr. 2024</span>
        <div class="rc143-recog-icons">
          ${['handshake','star','heart','leaf','group'].map((k,i)=>`<span class="rc143-mini">${rc143Icon(k,'r'+i)}</span>`).join('')}
        </div>
      </div>
      <details class="rc143-config"><summary>Personalizar reconhecimentos</summary><div class="rc143-config-body">${recognitionConfig}<div class="reward-config-actions"><button id="saveRecognitionPresets">Salvar reconhecimentos</button></div></div></details>
    </section>
  </div>`;

  document.querySelectorAll('[data-rc143-jump]').forEach(btn=>btn.onclick=()=>{
    const key=btn.dataset.rc143Jump;
    document.querySelectorAll('[data-rc143-jump]').forEach(x=>x.classList.toggle('active',x===btn));
    const target=key==='owner'?document.querySelector('#rc143Owner'):key==='kids'?document.querySelector('#rc143Kids'):document.querySelector('#rc143Helpers');
    target?.scrollIntoView({behavior:'smooth',block:'start'});
  });

  if(firstKid){
    document.querySelectorAll('[data-rc143-theme]').forEach(b=>b.onclick=()=>{
      const all=loadKidsRewardThemes();all[firstKid.id]=b.dataset.rc143Theme;saveKidsRewardThemes(all);
      document.querySelectorAll('[data-rc143-theme]').forEach(x=>x.classList.toggle('active',x===b));
    });
  }
  ...
  document.querySelector('#saveKidRewards143')?.addEventListener('click',e=>{
    if(!firstKid)return;
    const all=loadKidsRewards(),current=kidsRewardsFor(firstKid.id);
    document.querySelectorAll('[data-kid-reward]').forEach(row=>{
      const key=row.dataset.kidReward;
      current[key]={...current[key],
        name:row.querySelector('[data-kr-name]').value.trim()||current[key].name,
        points:Math.max(1,+row.querySelector('[data-kr-points]').value||1),
        type:row.querySelector('[data-kr-type]').value,
        icon:row.querySelector('[data-kr-icon]').value.trim()||current[key].icon||'★',
        recurrence:row.querySelector('[data-kr-rec]').value,
        visual:row.querySelector('[data-kr-visual]').value.trim(),
        description:row.querySelector('[data-kr-desc]').value.trim(),
        unlock:row.querySelector('[data-kr-unlock]')?.value||'badge',
    ...
    all[firstKid.id]=current;saveKidsRewards(all);
    e.currentTarget.textContent='Salvo';setTimeout(()=>e.currentTarget.textContent='Salvar premiações',900);
  });
...
renderUniversalRewards=renderRewardsRC143;
renderKidsRewards=renderRewardsRC143;

/* Garantia de render após toda a cadeia antiga de overrides */
(function(){
  const refresh=()=>{
    if((location.hash||'').replace('#','')==='premiacoes'){
      try{renderRewardsRC143()}catch(e){console.error('RC143 rewards',e)}
    }
  };
...
/* RC144 — Premiações reconstruídas para seguir o esboço aprovado e a lógica Owner/Kids/Helpers. */
const RC144_REWARD_ASSET='assets/rewards/';
function rc144Img(name,cls=''){return `<img class="rc144-art ${cls}" src="${RC144_REWARD_ASSET}${name}" alt="">`}
function rc144KidStreak(log=[]){
  const days=[...new Set((Array.isArray(log)?log:[]).map(x=>new Date(x.at||0).toISOString().slice(0,10)))].sort().reverse();
  if(!days.length)return 0;
  let streak=1, cur=new Date(days[0]+'T12:00:00');
...
function rc144KidRewardsFor(memberId){
  const all=loadKidsRewards(),raw=all[memberId]||{},defaults=kidsRewardDefaults();
  const merged={};
  Object.entries(defaults).forEach(([k,v])=>merged[k]={...v,...(raw[k]||{})});
  Object.entries(raw).forEach(([k,v])=>{if(!merged[k]&&v&&typeof v==='object')merged[k]={...v}});
  return merged;
}
kidsRewardsFor=rc144KidRewardsFor;

function rc144Styles(){
 if(document.getElementById('rc144-rewards'))return;
 const st=document.createElement('style');st.id='rc144-rewards';st.textContent=`
 .rc144-page{display:grid;gap:14px;padding-bottom:24px}
 .rc144-hero{min-height:176px!important;padding:22px!important;display:flex!important;align-items:center!important;position:relative!important;overflow:hidden!important;background:linear-gradient(135deg,rgba(249,214,226,.73),rgba(255,245,226,.82) 45%,rgba(220,235,252,.92))!important}
 .rc144-hero h2{font-size:29px!important;line-height:1.06!important;font-weight:400!important;letter-spacing:-.03em!important;color:#3f3945!important}
 .rc144-hero p{font-size:13.5px!important;line-height:1.48!important;font-weight:400!important;color:#746d78!important;max-width:500px!important}
 .rc144-bars{position:absolute;right:24px;bottom:30px;display:flex;align-items:flex-end;gap:8px;opacity:.78}
 .rc144-bars i{display:block;width:20px;border-radius:9px;box-shadow:inset 0 1px 0 rgba(255,255,255,.7),0 5px 14px rgba(80,64,90,.08)}
 .rc144-bars i:nth-child(1){height:38px;background:linear-gradient(#f6bad0,#e99aba)}
 .rc144-bars i:nth-child(2){height:56px;background:linear-gradient(#ffe9ca,#efcaa4)}
 .rc144-bars i:nth-child(3){height:78px;background:linear-gradient(#d9ecff,#a9cdf1)}
 .rc144-bars:after{content:'✦';position:absolute;right:-10px;top:-25px;color:#8a91be;font-size:17px}
 .rc144-tabs{display:grid;grid-template-columns:repeat(3,1fr);padding:4px;border-radius:20px;background:rgba(255,253,249,.8);border:1px solid rgba(126,115,132,.08)}
 .rc144-tabs button{min-height:44px;border:0;border-radius:16px;background:transparent;color:#77707c;font-size:12px;font-weight:400}
 .rc144-tabs button.active{background:#fffdfa;color:#403945;box-shadow:0 4px 15px rgba(74,57,69,.05)}
 .rc144-pane{display:grid;gap:14px}.rc144-pane[hidden]{display:none!important}
 .rc144-section{padding:16px;border-radius:26px;background:rgba(255,253,249,.85);border:1px solid rgba(126,115,132,.08);box-shadow:0 10px 24px rgba(74,57,69,.035)}
 .rc144-head{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:13px}
 .rc144-head h3{margin:0;font-size:20px;font-weight:430;letter-spacing:-.02em;color:#3f3945}.rc144-head p{margin:4px 0 0;font-size:11.5px;line-height:1.4;color:#8a818b;font-weight:400}
 .rc144-more,.rc144-add{border:1px solid rgba(211,143,172,.18);background:linear-gradient(110deg,#fff3f6,#fff7ef);color:#a15b79;border-radius:999px;min-height:34px;padding:0 13px;font-size:10.8px;font-weight:430}
 .rc144-grid4{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px}
 .rc144-tile{padding:10px 8px 12px;border-radius:20px;background:linear-gradient(155deg,#fffdfa,#fbf8f5);border:1px solid rgba(126,115,132,.08);display:grid;justify-items:center;text-align:center;gap:6px;min-height:154px}
 .rc144-tile.kid{min-height:166px}.rc144-art{display:block;object-fit:cover;border-radius:19px;width:76px;height:76px;box-shadow:0 7px 16px rgba(79,64,84,.08)}
 .rc144-tile.kid .rc144-art{width:84px;height:84px}.rc144-tile strong{font-size:10.8px;line-height:1.22;font-weight:430;color:#47414b}.rc144-tile small{font-size:9.5px;line-height:1.28;font-weight:400;color:#938a95}
 .rc144-theme-wrap{margin-top:11px;padding:13px;border-radius:19px;background:#fffdfa;border:1px solid rgba(126,115,132,.08)}
 .rc144-theme-title{display:flex;justify-content:space-between;gap:10px;align-items:center;margin-bottom:9px}.rc144-theme-title strong{font-size:12.5px;font-weight:430}.rc144-theme-title small{display:block;margin-top:2px;font-size:10.5px;color:#8a818b}
 .rc144-themes{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.rc144-theme{min-height:56px;border-radius:16px;border:1px solid rgba(126,115,132,.10);padding:9px 10px;text-align:left;font-size:10.5px;color:#514b57;position:relative}
 .rc144-theme.active:after{content:'✓';position:absolute;right:8px;top:7px;width:18px;height:18px;border-radius:50%;display:grid;place-items:center;background:#cc8cab;color:#fff;font-size:11px}
 .rc144-theme[data-theme="mist"]{background:linear-gradient(135deg,#f4e6ef,#e2eef9)}.rc144-theme[data-theme="ocean"]{background:linear-gradient(135deg,#dceefa,#bcdff1)}.rc144-theme[data-theme="space"]{background:linear-gradient(135deg,#6f6796,#3f4478);color:#fff}.rc144-theme[data-theme="forest"]{background:linear-gradient(135deg,#e4f1e6,#c8dfcf)}.rc144-theme[data-theme="solar"]{background:linear-gradient(135deg,#fff1ce,#f5dca6)}.rc144-theme[data-theme="coral"]{background:linear-gradient(135deg,#f9ded8,#efc9cb)}
 .rc144-kid-profile{display:grid;grid-template-columns:72px minmax(0,1fr) auto;gap:13px;align-items:center;padding:14px;border-radius:22px;background:linear-gradient(135deg,rgba(249,238,247,.95),rgba(237,246,252,.96));border:1px solid rgba(126,115,132,.08)}
 .rc144-avatar{width:68px;height:68px;border-radius:23px;display:grid;place-items:center;background:#fffdfa;border:1px solid rgba(126,115,132,.08)}.rc144-avatar svg{width:42px;height:42px}
 .rc144-kid-profile h4{margin:0;font-size:19px;font-weight:440;color:#403945}.rc144-kid-profile p{margin:3px 0 8px;font-size:10.5px;color:#8a818b}.rc144-points{padding:8px 11px;border-radius:999px;background:#fff2d9;color:#6f5d35;font-size:11px;font-weight:430;white-space:nowrap}
 .rc144-level{height:9px;border-radius:999px;background:#eee8ee;overflow:hidden}.rc144-level span{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,#c091ea,#ea9bc4,#f4b0bd)}
 .rc144-stats{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin-top:11px}.rc144-stat{padding:10px 8px;border-radius:18px;background:#fffdfa;border:1px solid rgba(126,115,132,.08);display:grid;grid-template-columns:48px 1fr;align-items:center;gap:7px}.rc144-stat img{width:48px;height:48px;border-radius:14px;object-fit:cover}.rc144-stat strong{font-size:10.5px;font-weight:430}.rc144-stat small{display:block;font-size:9.5px;color:#8a818b}
 .rc144-config-card{margin-top:12px;padding:14px;border-radius:22px;background:linear-gradient(135deg,#fff9fb,#f8f5ff);border:1px solid rgba(126,115,132,.08)}
 .rc144-config-title{display:flex;justify-content:space-between;align-items:flex-start;gap:10px;margin-bottom:12px}.rc144-config-title h4{margin:0;font-size:15px;font-weight:440}.rc144-config-title p{margin:3px 0 0;font-size:10.5px;color:#8a818b}
 .rc144-reward-editor{display:grid;grid-template-columns:92px minmax(0,1fr);gap:12px}.rc144-reward-editor .hero-art{width:92px;height:92px;border-radius:20px;object-fit:cover}.rc144-fields{display:grid;gap:9px}.rc144-fields label{display:grid;gap:5px;font-size:10.5px;color:#817984;font-weight:400}.rc144-fields input,.rc144-fields select{min-height:42px;border-radius:13px;border:1px solid rgba(126,115,132,.13);background:#fff;padding:9px 10px;font-size:16px;font-weight:400;color:#49434d}
 .rc144-mini-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.rc144-icon-picks{display:flex;gap:8px;flex-wrap:wrap}.rc144-icon-picks button{width:52px;height:52px;border-radius:14px;border:1px solid rgba(126,115,132,.10);padding:0;background:#fff}.rc144-icon-picks img{width:100%;height:100%;object-fit:cover;border-radius:13px}.rc144-icon-picks button.active{border-color:#cf7fa0;box-shadow:0 0 0 2px rgba(207,127,160,.10)}
 .rc144-highlights{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin-top:12px}.rc144-highlight{padding:10px;border-radius:17px;background:#fffdfa;border:1px solid rgba(126,115,132,.08);display:grid;grid-template-columns:46px 1fr;gap:7px;align-items:center}.rc144-highlight img{width:46px;height:46px;border-radius:13px;object-fit:cover}.rc144-highlight strong{font-size:10px;font-weight:430}.rc144-highlight small{font-size:9px;color:#8a818b}
 .rc144-recog{display:grid;grid-template-columns:70px minmax(0,1fr) auto;gap:12px;align-items:center;padding:14px;border-radius:21px;background:#fffdfa;border:1px solid rgba(126,115,132,.08)}.rc144-recog>.rc144-art{width:66px;height:66px}.rc144-recog strong{font-size:14px;font-weight:430}.rc144-recog p{margin:3px 0 0;font-size:10.5px;color:#8a818b;line-height:1.4}.rc144-date{padding:7px 10px;border-radius:999px;background:#fff7f1;border:1px solid rgba(126,115,132,.08);font-size:9.5px;color:#8a818b}
 .rc144-recog-icons{grid-column:2/4;display:flex;gap:8px}.rc144-recog-icons img{width:42px;height:42px;border-radius:14px;object-fit:cover}
 .rc144-modal{max-width:min(720px,calc(100vw - 24px))!important;width:100%!important;border:0!important;padding:0!important;background:transparent!important}.rc144-modal::backdrop{background:rgba(63,54,65,.30);backdrop-filter:blur(5px)}
 .rc144-modal-card{max-height:82dvh;overflow:auto;padding:18px;border-radius:26px;background:#fffaf5;border:1px solid rgba(126,115,132,.09);box-shadow:0 24px 60px rgba(55,43,67,.16)}.rc144-modal-head{display:flex;justify-content:space-between;align-items:flex-start;gap:10px;margin-bottom:14px}.rc144-modal-head h3{margin:0;font-size:21px;font-weight:430}.rc144-modal-close{width:42px;height:42px;border-radius:50%;border:1px solid rgba(126,115,132,.10);background:#fff;color:#6f6672;font-size:22px}
 .rc144-modal-list{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.rc144-modal-item{padding:12px;border-radius:18px;background:#fff;border:1px solid rgba(126,115,132,.08);display:grid;grid-template-columns:58px 1fr;gap:10px;align-items:center}.rc144-modal-item img{width:58px;height:58px;border-radius:16px;object-fit:cover}.rc144-modal-item strong{font-size:12px;font-weight:430}.rc144-modal-item small{display:block;margin-top:3px;font-size:10px;color:#8a818b}
 @media(max-width:560px){.rc144-grid4{grid-template-columns:repeat(2,minmax(0,1fr))}.rc144-themes{grid-template-columns:repeat(2,minmax(0,1fr))}.rc144-kid-profile{grid-template-columns:62px minmax(0,1fr)}.rc144-points{grid-column:2;justify-self:start}.rc144-stats,.rc144-highlights{grid-template-columns:repeat(2,minmax(0,1fr))}.rc144-reward-editor{grid-template-columns:1fr}.rc144-reward-editor .hero-art{width:86px;height:86px}.rc144-mini-grid{grid-template-columns:1fr}.rc144-recog{grid-template-columns:64px minmax(0,1fr)}.rc144-date{grid-column:2;justify-self:start}.rc144-recog-icons{grid-column:1/3}.rc144-modal-list{grid-template-columns:1fr}}
 `;document.head.appendChild(st)
}

function rc144OpenAll(kind,memberId){
 const d=document.createElement('dialog');d.className='rc144-modal';
 let title='',items=[];
 if(kind==='owner'){
   title='Todas as conquistas';
   const r=loadOwnerRewards();
   const art=['owner_medal.jpg','owner_mountain.jpg','owner_flame.jpg','owner_leaf.jpg'];
   items=r.map((x,i)=>({name:x.name,sub:x.description||'Conquista BERTH.A',art:art[i%art.length]}));
 }else if(kind==='kids'){
   title='Todas as premiações Kids';
   const cfg=kidsRewardsFor(memberId);
   const art={medal:'kid_stat_medal.jpg',trophy:'kid_stat_trophy.jpg',skin:'kid_stat_skin.jpg',egg:'kid_reward_star.jpg',companion:'kid_pick_bear.jpg'};
   items=Object.values(cfg).map(x=>({name:x.name||'Conquista',sub:`${Math.max(1,+x.points||1)} pontos · ${x.type||'medal'}`,art:art[x.type]||'kid_reward_star.jpg'}));
 }else{
   title='Todos os reconhecimentos';
   const p=loadRecognitionPresets();
   const art=['rec_handshake.jpg','rec_star.jpg','rec_heart_mini.jpg','rec_leaf.jpg','rec_group.jpg'];
   items=p.map((x,i)=>({name:x.name,sub:x.message||'',art:art[i%art.length]}));
 }
 d.innerHTML=`<div class="rc144-modal-card"><div class="rc144-modal-head"><div><div class="eyebrow">PREMIAÇÕES</div><h3>${escapeHtml(title)}</h3></div><button type="button" class="rc144-modal-close">×</button></div><div class="rc144-modal-list">${items.map(x=>`<div class="rc144-modal-item">${rc144Img(x.art)}<div><strong>${escapeHtml(x.name)}</strong><small>${escapeHtml(x.sub)}</small></div></div>`).join('')}</div></div>`;
 document.body.appendChild(d);d.querySelector('.rc144-modal-close').onclick=()=>d.close();d.addEventListener('click',e=>{if(e.target===d)d.close()});d.onclose=()=>d.remove();d.showModal();
}

function renderRewardsRC144(){
 ensureSatelliteStyles();ensureSatelliteIdentityV4();rc144Styles();
 const data=loadSatellites(),kids=(data.members||[]).filter(m=>m.status!=='removed'&&m.role==='kids');
 const owner=loadOwnerRewards(),presets=loadRecognitionPresets(),progress=loadKidsProgress(),themes=loadKidsRewardThemes();
 let selectedId=window.berthaHmlStorage.getItem('bertha.rewards.selected.kid')||kids[0]?.id||'';
 let kid=kids.find(x=>String(x.id)===String(selectedId))||kids[0];
 if(kid)selectedId=kid.id;
 const kp=kid?(progress[kid.id]||{season:0,lifetime:0,awards:[],log:[]}):{season:0,lifetime:0,awards:[],log:[]};
 const cfg=kid?kidsRewardsFor(kid.id):{};
 const cfgVals=Object.values(cfg),next=cfgVals.filter(r=>r.active!==false&&(+r.points||0)>(+kp.season||0)).sort((a,b)=>(+a.points||0)-(+b.points||0))[0];
 const level=Math.max(1,Math.floor((+kp.season||0)/100)+1),levelPct=((+kp.season||0)%100),toNext=100-levelPct;
 const medalCount=(kp.awards||[]).filter(a=>a.type==='medal').length,trophyCount=(kp.awards||[]).filter(a=>a.type==='trophy').length,skinCount=(kp.awards||[]).filter(a=>a.type==='skin').length,streak=rc144KidStreak(kp.log);
 const theme=kid?(themes[kid.id]||'mist'):'mist';
 const ownerTiles=[
   ['owner_medal.jpg','1 semana consistente','Há 2 dias'],['owner_mountain.jpg','Rotina em dia','Há 1 semana'],['owner_flame.jpg','Foco de 30 dias','Há 3 semanas'],['owner_leaf.jpg','Escolhas mais conscientes','Há 1 mês']
 ];
 const kidTiles=[
   ['kids_explorer.jpg','Explorador','Curioso por natureza'],['kids_reader.jpg','Super Leitor','3 livros lidos'],['kids_choice.jpg','Boa Escolha','Atitude incrível'],['kids_kind.jpg','Coração Gentil','Ajudou alguém']
 ];
 const themeButtons=['mist','ocean','space','forest','solar','coral'].map(t=>`<button type="button" class="rc144-theme ${t===theme?'active':''}" data-theme="${t}">${({mist:'Azul Neblina',ocean:'Oceano',space:'Espaço',forest:'Floresta',solar:'Solar',coral:'Coral'})[t]}</button>`).join('');
 const defaultEditor=cfgVals[0]||{name:'Missão de Estrela',points:50,type:'medal',active:true,criterion:'weekly'};
 app.innerHTML=`<div class="rc144-page">
 <section class="sat-hero sat-ideal-hero rc144-hero"><div class="sat-hero-copy"><div class="eyebrow">PREMIAÇÕES</div><h2>Você desempenha.<br>A BERTH.A reconhece.</h2><p>Conquistas para você. Gamificação para Kids. Reconhecimento para quem caminha junto.</p></div><div class="rc144-bars"><i></i><i></i><i></i></div></section>
 <div class="rc144-tabs"><button class="active" data-pane="owner">Owner</button><button data-pane="kids">Kids</button><button data-pane="helpers">Reconhecimentos</button></div>

 <section class="rc144-pane" data-rc144-pane="owner">
   <section class="rc144-section"><div class="rc144-head"><div><h3>Minhas conquistas</h3><p>Pequenas vitórias, grandes movimentos. Continue assim!</p></div><button type="button" class="rc144-more" data-see-all="owner">Ver todas ›</button></div>
   <div class="rc144-grid4">${ownerTiles.map(x=>`<div class="rc144-tile">${rc144Img(x[0])}<strong>${x[1]}</strong><small>${x[2]}</small></div>`).join('')}</div>
   <details class="rc144-config"><summary>Personalizar conquistas</summary><div class="rc144-config-body">${owner.map((r,i)=>`<div class="reward-config-card" data-owner-reward="${i}"><div class="reward-config-head"><span class="reward-config-icon">${escapeHtml(r.icon||'✦')}</span><div><strong>${escapeHtml(r.name)}</strong><small>${escapeHtml(r.description||'')}</small></div><label class="reward-active"><input type="checkbox" data-or-active ${r.active!==false?'checked':''}>Ativa</label></div><div class="reward-form-grid"><label>Nome<input data-or-name value="${escapeHtml(r.name)}"></label><label>Ícone<input data-or-icon value="${escapeHtml(r.icon||'✦')}"></label><label>Critério<select data-or-criterion><option value="progress100" ${r.criterion==='progress100'?'selected':''}>Progresso em 100%</option><option value="goal" ${r.criterion==='goal'?'selected':''}>Meta concluída</option><option value="streak" ${r.criterion==='streak'?'selected':''}>Sequência de dias</option><option value="cycle" ${r.criterion==='cycle'?'selected':''}>Ciclo concluído</option></select></label><label>Valor/meta<input type="number" min="1" data-or-value value="${Math.max(1,+r.value||1)}"></label><label>Recorrência<select data-or-rec><option value="once" ${r.recurrence==='once'?'selected':''}>Única</option><option value="each" ${r.recurrence==='each'?'selected':''}>A cada conquista</option><option value="weekly" ${r.recurrence==='weekly'?'selected':''}>Semanal</option><option value="monthly" ${r.recurrence==='monthly'?'selected':''}>Mensal</option></select></label><label>Visual<input data-or-visual value="${escapeHtml(r.visual||'Selo BERTH.A')}"></label></div><label>Descrição<input data-or-desc value="${escapeHtml(r.description||'')}"></label></div>`).join('')}<div class="reward-config-actions"><button id="rc144SaveOwner">Salvar conquistas</button></div></div></details>
   </section>
 </section>

 <section class="rc144-pane" data-rc144-pane="kids" hidden>
   ${kid?`<section class="rc144-section"><div class="rc144-head"><div><h3>Conquistas da sua Kids</h3><p>Acompanhe o progresso e celebre cada conquista.</p></div><select id="rc144KidSelect" style="min-height:36px;border-radius:999px;border:1px solid rgba(126,115,132,.1);background:#fff;padding:0 12px;font-size:12px">${kids.map(k=>`<option value="${k.id}" ${String(k.id)===String(kid.id)?'selected':''}>${escapeHtml(k.name)}</option>`).join('')}</select></div>
   <div class="rc144-kid-profile"><span class="rc144-avatar">${satelliteAvatarIcon(kid.avatarKey||'son')}</span><div><h4>${escapeHtml(kid.name)}</h4><p>${next?`${Math.max(0,(+next.points||0)-(+kp.season||0))} pontos para ${escapeHtml(next.name||'a próxima conquista')}`:'Todas as metas atuais alcançadas.'}</p><div class="rc144-level"><span style="width:${levelPct}%"></span></div><p style="display:flex;justify-content:space-between;margin-top:5px"><span>Nível ${level}</span><span>${toNext} pontos para o próximo nível</span></p></div><span class="rc144-points">★ ${+kp.season||0} pontos</span></div>
   <div class="rc144-stats"><div class="rc144-stat">${rc144Img('kid_stat_medal.jpg')}<div><strong>Medalhas</strong><small>${medalCount}/${Object.values(cfg).filter(r=>r.type==='medal').length||1}</small></div></div><div class="rc144-stat">${rc144Img('kid_stat_trophy.jpg')}<div><strong>Troféus</strong><small>${trophyCount}/${Object.values(cfg).filter(r=>r.type==='trophy').length||1}</small></div></div><div class="rc144-stat">${rc144Img('kid_stat_skin.jpg')}<div><strong>Skins</strong><small>${skinCount}/${Object.values(cfg).filter(r=>r.type==='skin').length||1}</small></div></div><div class="rc144-stat">${rc144Img('kid_stat_streak.jpg')}<div><strong>Streak</strong><small>${streak} dias</small></div></div></div>
   <div class="rc144-head" style="margin-top:14px;margin-bottom:0"><div><h3 style="font-size:15px">Coleção</h3></div><button type="button" class="rc144-more" data-see-all="kids">Ver todas ›</button></div>
   <div class="rc144-grid4" style="margin-top:10px">${kidTiles.map(x=>`<div class="rc144-tile kid">${rc144Img(x[0])}<strong>${x[1]}</strong><small>${x[2]}</small></div>`).join('')}</div>
   <div class="rc144-theme-wrap"><div class="rc144-theme-title"><div><strong>Temas de recompensa</strong><small>Personalize a coleção dos Kids</small></div><span>›</span></div><div class="rc144-themes">${themeButtons}</div></div>
   </section>
   <section class="rc144-section"><div class="rc144-head"><div><h3>Configurar novas premiações</h3><p>Personalize as regras e crie recompensas incríveis para ${escapeHtml(kid.name)}.</p></div><button class="rc144-add" id="rc144NewReward">＋ Nova premiação</button></div>
   <div class="rc144-config-card"><div class="rc144-config-title"><div><h4 id="rc144EditorTitle">${escapeHtml(defaultEditor.name||'Missão de Estrela')}</h4><p>Defina pontos, meta e o que será desbloqueado.</p></div><label class="reward-active"><input id="rc144RewardActive" type="checkbox" ${defaultEditor.active!==false?'checked':''}>Ativa</label></div>
   <div class="rc144-reward-editor">${rc144Img('kid_reward_star.jpg','hero-art')}<div class="rc144-fields"><label>Nome da premiação<input id="rc144RewardName" value="${escapeHtml(defaultEditor.name||'Missão de Estrela')}"></label><div class="rc144-mini-grid"><label>Pontos / meta<input id="rc144RewardPoints" type="number" min="1" value="${Math.max(1,+defaultEditor.points||50)}"></label><label>Tipo<select id="rc144RewardType"><option value="medal">Medalha</option><option value="trophy">Troféu</option><option value="egg">Cápsula</option><option value="skin">Skin</option><option value="companion">Personagem</option></select></label><label>Critério<select id="rc144RewardCriterion"><option value="points">Atingir pontos</option><option value="weekly">Concluir missões da semana</option><option value="streak">Sequência de dias</option><option value="mission">Missão específica</option></select></label></div></div></div>
   <div style="margin-top:12px"><span style="font-size:10.5px;color:#817984">Ícone da premiação</span><div class="rc144-icon-picks" style="margin-top:7px">${['kid_pick_star.jpg','kid_pick_trophy.jpg','kid_pick_crown.jpg','kid_pick_rainbow.jpg','kid_pick_rocket.jpg','kid_pick_gift.jpg','kid_pick_bear.jpg','kid_pick_gem.jpg'].map((a,i)=>`<button type="button" data-art="${a}" class="${i===0?'active':''}">${rc144Img(a)}</button>`).join('')}</div></div>
   <div class="reward-config-actions" style="margin-top:12px"><button id="rc144SaveKidReward">Salvar premiação</button></div></div>
   <div class="rc144-highlights"><div class="rc144-highlight">${rc144Img('kid_stat_medal.jpg')}<div><strong>Medalhas</strong><small>Colecione e evolua</small></div></div><div class="rc144-highlight">${rc144Img('kid_stat_trophy.jpg')}<div><strong>Troféus</strong><small>Grandes conquistas</small></div></div><div class="rc144-highlight">${rc144Img('kid_stat_skin.jpg')}<div><strong>Skins</strong><small>Personalize a jornada</small></div></div><div class="rc144-highlight">${rc144Img('kid_pick_rocket.jpg')}<div><strong>Missão da semana</strong><small>Desafios especiais</small></div></div></div>
   </section>`:`<section class="rc144-section"><div class="sat-empty">Cadastre um satélite como Kids para configurar a gamificação.</div></section>`}
 </section>

 <section class="rc144-pane" data-rc144-pane="helpers" hidden>
   <section class="rc144-section"><div class="rc144-head"><div><h3>Reconhecimentos</h3><p>Valorize quem caminha com você.</p></div><button type="button" class="rc144-more" data-see-all="helpers">Ver todas ›</button></div>
   <div class="rc144-recog">${rc144Img('rec_heart.jpg')}<div><strong>Ajuda incrível</strong><p>A BERTH.A registrou: essa ajuda fez tudo mais leve.</p></div><span class="rc144-date">12 abr. 2024</span><div class="rc144-recog-icons">${['rec_handshake.jpg','rec_star.jpg','rec_heart_mini.jpg','rec_leaf.jpg','rec_group.jpg'].map(a=>rc144Img(a)).join('')}</div></div>
   <details class="rc144-config"><summary>Personalizar reconhecimentos</summary><div class="rc144-config-body">${presets.map((r,i)=>`<div class="reward-config-card" data-rec-preset="${i}"><div class="reward-config-head"><span class="reward-config-icon">${escapeHtml(r.icon||'✦')}</span><div><strong>${escapeHtml(r.name||'Reconhecimento')}</strong><small>${escapeHtml(r.message||'')}</small></div><label class="reward-active"><input type="checkbox" data-rp-active ${r.active!==false?'checked':''}>Ativo</label></div><div class="reward-form-grid"><label>Símbolo<input data-rp-icon value="${escapeHtml(r.icon||'✦')}"></label><label>Nome<input data-rp-name value="${escapeHtml(r.name||'')}"></label></div><label>Mensagem<input data-rp-message value="${escapeHtml(r.message||'')}"></label></div>`).join('')}<div class="reward-config-actions"><button id="rc144SaveRecognition">Salvar reconhecimentos</button></div></div></details>
   </section>
 </section>
 </div>`;

 const activate=(pane)=>{document.querySelectorAll('[data-pane]').forEach(b=>b.classList.toggle('active',b.dataset.pane===pane));document.querySelectorAll('[data-rc144-pane]').forEach(p=>p.hidden=p.dataset.rc144Pane!==pane)};
 document.querySelectorAll('[data-pane]').forEach(b=>b.onclick=()=>activate(b.dataset.pane));
 document.querySelectorAll('[data-see-all]').forEach(b=>b.onclick=()=>rc144OpenAll(b.dataset.seeAll,kid?.id));
 document.querySelector('#rc144KidSelect')?.addEventListener('change',e=>{window.berthaHmlStorage.setItem('bertha.rewards.selected.kid',e.target.value);renderRewardsRC144();activate('kids')});
 document.querySelectorAll('[data-theme]').forEach(b=>b.onclick=()=>{if(!kid)return;const all=loadKidsRewardThemes();all[kid.id]=b.dataset.theme;saveKidsRewardThemes(all);document.querySelectorAll('[data-theme]').forEach(x=>x.classList.toggle('active',x===b))});
 let chosenArt='kid_pick_star.jpg';document.querySelectorAll('[data-art]').forEach(b=>b.onclick=()=>{chosenArt=b.dataset.art;document.querySelectorAll('[data-art]').forEach(x=>x.classList.toggle('active',x===b));const hero=document.querySelector('.hero-art');if(hero)hero.src=RC144_REWARD_ASSET+chosenArt});
 document.querySelector('#rc144NewReward')?.addEventListener('click',()=>{document.querySelector('#rc144RewardName').value='';document.querySelector('#rc144RewardPoints').value=50;document.querySelector('#rc144RewardType').value='medal';document.querySelector('#rc144RewardCriterion').value='points';document.querySelector('#rc144RewardActive').checked=true;document.querySelector('#rc144EditorTitle').textContent='Nova premiação';document.querySelector('#rc144RewardName').focus()});
 document.querySelector('#rc144SaveKidReward')?.addEventListener('click',e=>{if(!kid)return;const name=document.querySelector('#rc144RewardName').value.trim();if(!name)return document.querySelector('#rc144RewardName').focus();const all=loadKidsRewards(),raw=all[kid.id]||{},key='custom_'+Date.now();raw[key]={name,points:Math.max(1,+document.querySelector('#rc144RewardPoints').value||1),type:document.querySelector('#rc144RewardType').value,criterion:document.querySelector('#rc144RewardCriterion').value,active:document.querySelector('#rc144RewardActive').checked,art:chosenArt,recurrence:'season'};all[kid.id]=raw;saveKidsRewards(all);e.currentTarget.textContent='Salvo';setTimeout(()=>{renderRewardsRC144();activate('kids')},500)});
 document.querySelector('#rc144SaveOwner')?.addEventListener('click',e=>{const current=loadOwnerRewards(),vals=[...document.querySelectorAll('[data-owner-reward]')].map((row,i)=>({...current[i],name:row.querySelector('[data-or-name]').value.trim()||current[i].name,icon:row.querySelector('[data-or-icon]').value.trim()||current[i].icon||'✦',criterion:row.querySelector('[data-or-criterion]').value,value:Math.max(1,+row.querySelector('[data-or-value]').value||1),recurrence:row.querySelector('[data-or-rec]').value,visual:row.querySelector('[data-or-visual]').value.trim(),description:row.querySelector('[data-or-desc]').value.trim(),active:row.querySelector('[data-or-active]').checked}));saveOwnerRewards(vals);e.currentTarget.textContent='Salvo';setTimeout(()=>e.currentTarget.textContent='Salvar conquistas',900)});
 document.querySelector('#rc144SaveRecognition')?.addEventListener('click',e=>{const base=loadRecognitionPresets(),vals=[...document.querySelectorAll('[data-rec-preset]')].map((row,i)=>({...base[i],icon:row.querySelector('[data-rp-icon]').value.trim()||base[i].icon||'✦',name:row.querySelector('[data-rp-name]').value.trim()||base[i].name,message:row.querySelector('[data-rp-message]').value.trim(),active:row.querySelector('[data-rp-active]').checked}));saveRecognitionPresets(vals);e.currentTarget.textContent='Salvo';setTimeout(()=>e.currentTarget.textContent='Salvar reconhecimentos',900)});
}

renderUniversalRewards=renderRewardsRC144;
renderKidsRewards=renderRewardsRC144;
(function(){const refresh=()=>{if((location.hash||'').replace('#','')==='premiacoes')try{renderRewardsRC144()}catch(e){console.error('RC144 rewards',e)}};requestAnimationFrame(()=>requestAnimationFrame(refresh));setTimeout(refresh,100);setTimeout(refresh,360)})();
