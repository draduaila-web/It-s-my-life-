/* ============================================================
 BERTH.A RC166 — asset family final + acessórios personalizáveis
 ============================================================ */
(function(){
 const BASE='assets/rewards-v166/';
 const PNG=new Set(['capsule_ocean','ocean_turtle_cute','ocean_shark_cute','ocean_acc_backpack','ocean_acc_collar','ocean_acc_glasses','ocean_acc_cap','medal_gold','super_trophy','solar_lion_cute']);
 const known=new Set([
 ...
 'solar_lion_cute','solar_dragon_cute','solar_phoenix_cute','coral_axolotl_cute','coral_octopus_cute','coral_seahorse_cute',
 ...
 const COLOR_KEY='bertha.kids.accessory.colors.v166';
 ...
 document.documentElement.dataset.berthaBuild='RC166';
})();