/* ============================================================
 BERTH.A RC168 — asset family final + acessórios personalizáveis
 ============================================================ */
(function(){
 const BASE='';
 const PNG=new Set(['capsule_ocean','ocean_turtle_cute','ocean_shark_cute','ocean_acc_backpack','ocean_acc_collar','ocean_acc_glasses','ocean_acc_cap','medal_gold','super_trophy','solar_lion_cute','pin_constancy','pin_cycle','pin_focus','pin_goal','pin_presence','pin_balance','capsule_space','capsule_coral','capsule_solar','capsule_forest','capsule_mist','ocean_dolphin_cute','ocean_octopus_cute','ocean_whale_cute','ocean_clownfish_cute']);
 const known=new Set([
 'recognition_heart','recognition_flower','recognition_coffee','recognition_dinner','recognition_family','recognition_gift','recognition_hug',
 'pin_constancy','pin_cycle','pin_focus','pin_balance','pin_goal','pin_presence',
 ...
 // New recognition presets use the final family.
 const oldPresets=window.r147RecognitionPresets;
 window.r147RecognitionPresets=r147RecognitionPresets=function(){
   const saved=window.berthaHmlStorage.getItem('bertha.recognition.presets.v2');
   if(saved){try{return JSON.parse(saved)}catch{}}
   return [
    {asset:'recognition_heart',name:'Obrigada por hoje',message:'Obrigada por deixar o meu dia mais leve.',active:true},
    {asset:'recognition_flower',name:'Uma flor para você',message:'Um carinho para agradecer pela ajuda.',active:true},
    {asset:'recognition_coffee',name:'Vale café',message:'Um café por minha conta. Obrigada pela ajuda.',active:true},
    {asset:'recognition_dinner',name:'Vale jantar a dois',message:'Quero retribuir esse cuidado com um jantar a dois.',active:true},
    {asset:'recognition_family',name:'Vale almoço em família',message:'Esse reconhecimento vale um almoço gostoso em família.',active:true},
    {asset:'recognition_gift',name:'Um mimo para você',message:'Você fez diferença. Quero te dar um mimo.',active:true},
    {asset:'recognition_hug',name:'Um abraço em forma de obrigada',message:'Receba esse carinho como meu obrigada.',active:true}
   ];
 };
 ...
 function apply(){personalizeAccessories();fixHelper();}
 const style=document.createElement('style');style.id='rc166-style';style.textContent=`
 ...
 window.renderRewardsV166=function(tab=''){const out=base?.(tab);requestAnimationFrame(apply);return out};
 window.renderRewardsV164=window.renderRewardsV166;window.renderRewardsV163=window.renderRewardsV166;window.renderUniversalRewards=window.renderRewardsV166;window.renderKidsRewards=window.renderRewardsV166;
 ...
 document.documentElement.dataset.berthaBuild='RC168';
})();