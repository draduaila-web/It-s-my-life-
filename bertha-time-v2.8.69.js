...
(() => {
  ...
  function renderRitualDetail(id){
    ...
    return `<section class="bertha-ritual-page">
      <button class="bertha-back-link" type="button" data-back-rituals>‹ Rituais</button>
  ...
  function bindRitualDetail(id){
    document.querySelector('[data-back-rituals]')?.addEventListener('click',()=>{location.hash='#rituais';rerender();});
