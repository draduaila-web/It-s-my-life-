...
(() => {
  ...
  function renderRituals(){
    ...
    return `<section class="bertha-ritual-page">
      <section class="bertha-ritual-hero"><div class="bertha-task-kicker">RITUAIS</div><h1>Space to think. Space to live.</h1><p>Você configura uma vez. A BERTH.A traz o cuidado para o seu dia quando ele fizer sentido.</p></section>
