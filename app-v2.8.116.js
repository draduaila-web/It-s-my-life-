...
function ensureFoodModuleStyles(){
 ...
 .food-v115-hero h2{max-width:82%;margin:0 0 8px;color:#343441;font-size:28px!important;line-height:1.08!important;font-weight:400!important;letter-spacing:-.022em!important}
 .food-v115-hero p{max-width:82%;margin:13px 0 0;color:#7f7b84;font-size:17px;line-height:1.42}
 .food-v115-abstract{position:absolute;right:28px;top:28px;width:27px;height:27px;border:1.5px solid rgba(109,113,122,.38);transform:rotate(45deg);border-radius:1px}
 .food-v115-today{margin:0 0 18px;padding:20px 22px;border:1px solid rgba(109,136,164,.14);border-radius:25px;background:linear-gradient(135deg,rgba(255,255,255,.68),rgba(246,250,254,.82));box-shadow:0 12px 30px rgba(72,89,106,.045)}
 ...
 .food-v115-card{border:1px solid rgba(104,125,146,.13)!important;border-radius:24px!important;background:rgba(255,255,255,.72)!important;box-shadow:0 11px 26px rgba(72,89,106,.04)!important}
 ...
 @media(max-width:520px){.food-v115-hero{padding:22px 22px 23px}.food-v115-hero h2{font-size:27px!important;font-weight:400!important}.food-v115-hero h2,.food-v115-hero p{max-width:84%}.food-v115-abstract{right:24px;top:27px;width:23px;height:23px}.food-v115-today{padding:18px 16px}.food-v115-today-grid{grid-template-columns:1fr}.food-v115-meal{padding:13px 2px}.food-v115-meal+.food-v115-meal{border-left:0;border-top:1px solid rgba(80,103,126,.08)}.food-v115-meal strong{min-height:0;font-size:15px}.food-v115-actions{margin-top:9px}.food-v115-dinner-row{grid-template-columns:44px minmax(0,1fr) auto}}
 `;document.head.appendChild(st)
}
