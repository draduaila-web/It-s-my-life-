...
function renderTrabalho(){
 ...
 <section class="work-grid work-front-v11">
  <button class="card work-card work-card-crefito" data-work-route="trabalho-crefito">
   <span class="work-icon work-logo-wrap"><img class="work-logo" src="https://www.crefito11.gov.br/arquivos/img_logo/logo.png" alt="CREFITO-11" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><span class="logo-fallback">C11</span></span>
   <strong>CREFITO-11</strong><span>Trabalho oficial · 08:00–14:00</span>
  </button>
  <button class="card work-card work-card-bec" data-work-route="trabalho-bec">
   <span class="work-icon"><span class="bec-wordmark">BEC</span></span>
   <strong>BEC</strong><span>Empresa, projetos e operações.</span>
  </button>
  <button class="card work-card work-card-tiktok" data-work-route="trabalho-tiktok">
   <span class="work-icon"><span class="tiktok-wordmark"><i>♪</i></span></span>
   <strong>TikTok</strong><span>Conteúdo, ideias e presença digital.</span>
  </button>
 </section>
