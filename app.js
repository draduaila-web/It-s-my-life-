...
function renderCrefito(){
 ...
 app.innerHTML=`<section class="hero"><div class="eyebrow">💼 TRABALHO</div><h2>🏛️ CREFITO-11</h2><p>Setor de Negociação · trabalho oficial.</p></section>
 <div class="work-subnav"><button class="work-back" id="backWork">← Trabalho</button><p class="work-subtitle">SETOR DE NEGOCIAÇÃO · 08:00–14:00</p></div>
 <section class="card work-panel crefito-intro"><span class="panel-tag">ATUAÇÃO</span><h3>Reestruturação e gestão dos processos do Setor de Negociação</h3><span>Foco em atendimento, negociação de débitos, parcelamentos, cobrança e recuperação de créditos.</span></section>
 <section class="work-section"><div class="section-title">PRINCIPAIS RESPONSABILIDADES</div><section class="card work-panel"><ul class="crefito-list"><li>Gestão e organização dos processos do setor.</li><li>Atendimento a profissionais e empresas.</li><li>Negociação, parcelamento e reparcelamento de débitos.</li><li>Emissão e orientação sobre boletos, certidões e declarações.</li><li>Cobrança administrativa e campanhas de recuperação de débitos.</li><li>Acompanhamento de notificações, Dívida Ativa e protestos.</li><li>Gestão de processos no SEI e interface com Jurídico, Presidência, Tesouraria e demais setores.</li><li>Padronização de procedimentos, respostas e controles.</li><li>Desenvolvimento de POPs, fluxos, checklists e treinamento da equipe.</li><li>Otimização do uso do Implanta/Siscaf e avaliação de automações.</li><li>Acompanhamento de indicadores e resultados do setor.</li></ul></section></section>
 <section class="card work-panel crefito-project"><span class="panel-tag">PROJETO ATUAL</span><h3>Reestruturar o setor</h3><span>Criar uma operação padronizada, rastreável, integrada e eficiente, reduzindo controles paralelos, aumentando a autonomia da equipe e utilizando tecnologia e automação sempre que possível.</span></section>
 <section class="card work-rule crefito-rule"><strong>REGRA CENTRAL</strong><div>Eliminar o desnecessário → padronizar o necessário → automatizar o possível → registrar uma vez → acompanhar no lugar certo.</div></section>
