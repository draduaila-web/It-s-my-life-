...
function sessionHtml(s){return `<article class="card"><strong>${escapeHtml(s.subject||s.title||"Estudo")}</strong><div class="study-meta">${escapeHtml(s.date||"")} · ${+s.minutes||0} min</div></article>`}
