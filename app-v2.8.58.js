// BERTH.A v2.8.58 — correção local do alinhamento dos campos no modal Criação & Ideias
...
@media(max-width:480px){
 #ideaDialog{max-height:100dvh!important;overflow:hidden!important}
 #ideaDialog #ideaForm{width:min(92vw,520px)!important;max-height:82dvh!important;overflow-y:auto!important;overflow-x:hidden!important;-webkit-overflow-scrolling:touch!important;overscroll-behavior:contain;padding:18px 18px max(30px,env(safe-area-inset-bottom))!important}
