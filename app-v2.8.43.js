...
function openPlannedBillModal(id){
 ...
 const dlg=document.createElement("dialog");dlg.innerHTML=`<form method="dialog" class="modal-card" id="finPlanForm"><div class="modal-head"><div><div class="eyebrow">💰 CONTA PREVISTA</div><h2>${existing?"Editar conta prevista":"Nova conta prevista"}</h2></div><button class="icon-btn" value="cancel">×</button></div>
