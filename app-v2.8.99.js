...
/* =========================================================
   CRIAÇÃO & IDEIAS — v2.8.97 · look azul + modal adaptativo
...
@media(max-width:480px){
 ...
 #ideaDialog .project-track-master{display:grid!important;grid-template-columns:20px minmax(0,1fr)!important;align-items:start!important;column-gap:10px!important;width:100%!important}
 #ideaDialog .project-track-master>input[type=checkbox]{grid-column:1!important;margin-top:2px!important}
 #ideaDialog .project-track-master>span{grid-column:2!important;min-width:0!important}
 #ideaDialog #projectInactiveDaysWrap{display:grid!important;grid-template-columns:20px minmax(0,1fr)!important;column-gap:10px!important;align-items:center!important;margin-top:2px!important;padding-left:0!important}
 #ideaDialog #projectInactiveDaysWrap>span{grid-column:2!important}
 #ideaDialog #projectInactiveDaysWrap>input{grid-column:2!important;width:100%!important;margin-top:5px!important}
 #ideaDialog .modal-actions{position:relative!important;display:flex!important;flex-wrap:wrap!important;gap:10px!important;padding-top:8px!important;padding-bottom:4px!important}
  ...
  function drawConditional(){
    ...
    conditional.innerHTML=`
      ...
      <label class="project-track-master" style="display:flex;gap:10px;align-items:flex-start"><input id="projectTrack" type="checkbox" ${p?.trackProject!==false?'checked':''} style="width:auto;margin-top:3px"><span><strong>Quero que a BERTA acompanhe este projeto</strong><small style="display:block">Ela pode lembrar de continuidade e mostrar em que etapa você está.</small></span></label>
      <div id="projectTrackOptions" class="card" style="padding:12px;margin:0 0 12px">
        ...
        <label id="projectInactiveDaysWrap"><span>Dias sem avanço</span><input id="projectInactiveDays" type="number" min="1" max="60" value="${+p?.inactiveDays||7}"></label>
      </div>`;
