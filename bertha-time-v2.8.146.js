...
(() => {
  ...
  function currentSuggestion(){
    ...
    const homeMaint=pick('home-maintenance'); if(homeMaint) return {item:homeMaint};
    const home=pick('home-routine'); if(home) return {item:home};
    const ritual=pick('ritual'); if(ritual) return {item:ritual};
    const window=pick('window'); if(window) return {item:window};
    const study=list.find(x=>x.kind==='study' && fits(x)); if(study) return {item:study};
    const project=pick('project'); if(project) return {item:project};
    return {free:true};
  }
  ...
  function goalAreaIcon(area){
    const icons={
      exercicios:'<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.8 10.3v3.4M6.6 8.2v7.6M9.4 10.1v3.8M14.6 10.1v3.8M17.4 8.2v7.6M20.2 10.3v3.4M9.4 12h5.2"/></svg>',
  ...
  function ensureStyles(){
    ...
    .bertha-ideal-hero{
      ...
      background:
        linear-gradient(135deg, rgba(246,214,224,.76) 0%, rgba(252,246,239,.96) 28%, rgba(231,242,255,.95) 100%),
        linear-gradient(135deg, rgba(255,255,255,0) 40%, rgba(255,243,191,.24) 44%, rgba(255,247,210,.48) 46.5%, rgba(255,255,255,.98) 49.2%, rgba(255,253,242,1) 50%, rgba(255,255,255,.98) 50.8%, rgba(255,247,210,.46) 53.5%, rgba(255,243,191,.22) 56%, rgba(255,255,255,0) 60%),
        radial-gradient(ellipse 20% 135% at 50% 48%, rgba(255,255,255,.99) 0%, rgba(255,252,232,.96) 16%, rgba(255,247,199,.72) 27%, rgba(255,242,182,.28) 36%, rgba(255,242,182,0) 52%)!important;
    ...
    .bertha-ideal-page .primary.add-full{
      background:linear-gradient(135deg, rgba(226,170,190,.98) 0%, rgba(248,234,216,.98) 46%, rgba(216,231,246,.98) 100%)!important;
      color:#fff!important;border:1px solid rgba(201,161,180,.24)!important;box-shadow:0 10px 24px rgba(196,170,198,.10)!important
    }
    ...
    .bertha-goal-card.goal-exercicios{background:linear-gradient(135deg,rgba(252,248,244,.98),rgba(242,231,248,.22) 38%,rgba(251,238,229,.18) 100%)}
    .bertha-goal-card.goal-exercicios .bertha-goal-icon{color:#7c748e}
    ...
    .bertha-dialog .bertha-primary{
      background:linear-gradient(135deg, rgba(226,170,190,.98) 0%, rgba(248,234,216,.98) 46%, rgba(216,231,246,.98) 100%)!important;
      color:#fff!important;border:1px solid rgba(201,161,180,.24)!important;box-shadow:none!important
    }
