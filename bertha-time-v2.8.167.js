...
(() => {
  ...
  function ensureMeuDiaV167Styles(){
    if(document.getElementById('bertha-meu-dia-v167'))return;
    const st=document.createElement('style');st.id='bertha-meu-dia-v167';st.textContent=`
      /* MEU DIA v167 — fluxo cromático contínuo da marca */
